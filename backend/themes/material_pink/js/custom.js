...
// Clients carousel (uses the Owl Carousel library)
  $(".staff-carousel").owlCarousel({
    ...
    responsive: { 0: { items: 1 }, 768: { items: 3 }, 900: { items: 6 }
    }
  });

  // Clients carousel (uses the Owl mentors)
  $(".mentors").owlCarousel({
    autoplay: true,
    nav    : true,
    dots: false,
...
$(".achievements").owlCarousel({
  ...
  responsive: { 0: { items: 1 }, 768: { items: 1 }, 900: { items: 1 }
   ...
   // photogallery carousel (uses the Owl Carousel library)
  ...
  $(".courses-carousel").owlCarousel({
   ...
   // curricular (uses the Owl Carousel library)
   $(".curricular").owlCarousel({
    autoplay: true,
    nav    : true,
    dots: false,
    loop: true,
