...
class Customlib
{
    ...
    public function getPageContentCategory()
    {
        ...
        $category['co-curriculam']  = "co-curriculam";
        $category['testimonials']  = "testimonials";
        $category['facility']  = "facility";// $this->CI->lang->line('facility');
        $category['sports']  = "sports";//$this->CI->lang->line('sports');
        $category['achievements']  = "achievements";//$this->CI->lang->line('sports');
        return $category;
    }
