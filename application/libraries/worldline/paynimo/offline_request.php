...
if(isset($_POST))
{
	...
	echo '<table class="table table-bordered table-hover" border = "1" align="center" cellpadding="2" cellspacing="0" style="width: 50%;text-align: center;">
                <thead>
                  <tr class="info">
                    <th>Field Name</th>
                    <th>Value</th>
                ...
                <tbody>
                  <tr>
                    <td>Merchant Code</td>
                    <td>'.$offlineVerifyData["merchantCode"].'</td>
                  </tr>
                  <tr>
                    <td>Merchant Transaction Identifier</td>
                    <td>'.$offlineVerifyData["merchantTransactionIdentifier"].'</td>
                  </tr>
                  <tr>
                    <td>Token Identifier</td>
                    <td>'.$offlineVerifyData["paymentMethod"]["paymentTransaction"]["identifier"].'</td>
                  </tr>
                  <tr>
                    <td>Amount</td>
                    <td>'.$offlineVerifyData["paymentMethod"]["paymentTransaction"]["amount"].'</td>
                  </tr>
                  <tr>
                    <td>Message</td>
                    <td>'.$offlineVerifyData["paymentMethod"]["paymentTransaction"]["errorMessage"].'</td>
                  </tr>
                  <tr>
                    <td>Status Code</td>
                    <td>'.$offlineVerifyData["paymentMethod"]["paymentTransaction"]["statusCode"].'</td>
                  </tr>
                  <tr>
                    <td>Status Message</td>
                    <td>'.$offlineVerifyData["paymentMethod"]["paymentTransaction"]["statusMessage"].'</td>
                  </tr>
                  <tr>
                    <td>Date & Time</td>
                    <td>'.$offlineVerifyData["paymentMethod"]["paymentTransaction"]["dateTime"].'</td>
                  </tr>
                </tbody>
              </table>
              <br>
              <a href=' .$base_url. "offline_verification.php" . '>Go Back To Offline Verification Page</a>';
}
