...
class Teachersubject_model extends MY_Model
{
    ...
    {
        $this->db->select('teacher_subjects.*,subjects.name,classes.class,class_sections.section_id,class_id,sections.section');
    ...
    function getTeacherSubjects($teacher_id, $subject_id)
    {
        $this->db->select('teacher_subjects.*,subjects.name as subname,staff.name');
        $this->db->from('teacher_subjects');
        $this->db->join('subjects', 'subjects.id = teacher_subjects.subject_id');
