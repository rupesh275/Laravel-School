...
class Setting_model extends MY_Model {
    ...
    public function get($id = null) {
        ...
        $this->db->select('sch_settings.id,sch_settings.website,sch_settings.lang_id,sch_settings.languages,sch_settings.class_teacher,sch_settings.is_rtl,sch_settings.cron_secret_key, sch_settings.timezone,sch_settings.print_letter,sch_settings.school_UDISE,
          sch_settings.name,sch_settings.email,sch_settings.biometric,sch_settings.biometric_device,sch_settings.time_format,sch_settings.phone,languages.language,sch_settings.attendence_type,sch_settings.school_ref_code,sch_settings.affilation_no,
    ...
    public function getSchoolDetail($id = null) {
        ...
        $this->db->select('sch_settings.id,sch_settings.website,sch_settings.lang_id,sch_settings.is_rtl,sch_settings.timezone,
          ...
          sch_settings.address,sch_settings.dise_code,sch_settings.date_format,sch_settings.currency,sch_settings.currency_symbol,sch_settings.start_month,sch_settings.start_week,sch_settings.session_id,sch_settings.image,sch_settings.theme,sessions.session,sch_settings.online_admission'
        );
        $this->db->from('sch_settings');
        $this->db->join('sessions', 'sessions.id = sch_settings.session_id');
        $this->db->join('languages', 'languages.id = sch_settings.lang_id');
    ...
    public function getSetting() {
        ...
        $this->db->select('sch_settings.id,sch_settings.website,sch_settings.attendence_type,sch_settings.lang_id,sch_settings.is_rtl,sch_settings.fee_due_days,sch_settings.class_teacher,sch_settings.cron_secret_key,sch_settings.timezone,sch_settings.print_letter,sch_settings.school_ref_code,
    ...
    public function getuserparentLanguage() {

        $query = $this->db->select('languages.language,languages.short_code')->where('id', $this->session->userdata['parent']['language']['lang_id'])->get('languages');
        return $query->row_array();
    }
