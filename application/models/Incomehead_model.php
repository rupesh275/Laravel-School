...
class Incomehead_model extends My_Model {
    ...
    public function addBankHead($data) {
        ...
        if (!empty($data['id'])) {
            ...
            $message = UPDATE_RECORD_CONSTANT . " On  bank master   id " . $data['id'];
            $action = "Update";
            $record_id = $return_value = $data['id'];
        } else {
            $this->db->insert('bank_master', $data);
            $return_value = $this->db->insert_id();
            $message = INSERT_RECORD_CONSTANT . " On  bank master   id " . $return_value;
            $action = "Insert";
            $record_id = $return_value;
        }
        $this->log($message, $record_id, $action);
    ...
    public function getBankHead($id = null) {
    ...
    public function remove_bank_head($id) {
        ...
        //$return_value = $this->db->insert_id();
        $message = DELETE_RECORD_CONSTANT . " On  bank master   id " . $id;
        $action = "Delete";
        $record_id = $id;
        $this->log($message, $record_id, $action);
