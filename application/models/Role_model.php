...
// # Updating data
    ...
    public function getPermissionsResult($role_id)
    {
        $this->db->where('role_id', $role_id);
      return  $this->db->get('roles_permissions')->result_array();
        
    }

    public function insertduplicatePermission($insertArray)
    {
        if (!empty($insertArray)) {
            $this->db->insert_batch('roles_permissions', $insertArray);
        }
    }
}
