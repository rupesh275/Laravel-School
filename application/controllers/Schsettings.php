...
class Schsettings extends Admin_Controller
{
    ...
    public function ajax_schedit()
    {
        ...
        $this->form_validation->set_rules('sch_website', "Website", 'trim|required|xss_clean');
        ...
        if ($this->form_validation->run() == false) {
            $data = array(
                ...
                'sch_website'               => form_error('sch_website'),
            ...
            $data = array(
                ...
                'last_certificate_no'       => $this->input->post('last_certificate_no'),
                'school_UDISE'              => $this->input->post('school_UDISE'),
                'school_ref_code'           => $this->input->post('school_ref_code'),
                'affilation_no'             => $this->input->post('affilation_no'),
                'print_letter'              => $this->input->post('print_letter'),
                'library_return_days'       => $this->input->post('library_return_days'),
