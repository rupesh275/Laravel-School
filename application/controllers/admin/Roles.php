...
class Roles extends Admin_Controller {
    ...
    function index() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $inserted_id = $this->role_model->add($data);
            $role_id = $this->input->post('role_id');
            $role_permission = [];
            if (!empty($role_id)) {
            $role_permission = $this->role_model->getPermissionsResult($role_id);
            }
            ...
            if (!empty($role_permission)) {
                ...
                $this->role_model->insertduplicatePermission($insert_array);
            }
