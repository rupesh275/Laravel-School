...
class Grade extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        $this->form_validation->set_rules('grade_system', $this->lang->line('grade')." ".$this->lang->line('system'), 'trim|required|xss_clean');
        $this->form_validation->set_rules('grade_remark', $this->lang->line('grade')." ".$this->lang->line('remark'), 'trim|required|xss_clean');
        if ($this->form_validation->run() == false) {
            ...
            $data = array(
                ...
                'grade_system'       => $this->input->post('grade_system'),
