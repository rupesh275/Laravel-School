...
$config['ci_front_news_content']  = 'news';
$config['ci_front_facility_content']  = 'facility';
$config['ci_front_co-curriculam_content']  = 'co-curriculam';
$config['ci_front_testimonials_content']  = 'testimonials';
$config['ci_front_sports_content']  = 'sports';
$config['ci_front_gallery_content'] = 'gallery';
$config['ci_front_banner_content']  = 'banner';
$config['ci_front_achievements_content']  = 'achievements';
