        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box removeboxmius">
                    ...
                    <form action="<?php echo site_url('report/division_wise_adm_report') ?>" method="post" class="" id="s">
                    ...
                    <div class="" id="transfee">
                        ...
                        <div class="box-header ptbnull">
                            <h3 class="box-title titlefix"><i class="fa fa-money"></i> <?php echo "Division Wise Admission Report For the Year 2023-24"; ?></h3>
                        </div>
                        ...
                        <table class="table table-striped table-bordered  table-hover " id="headerTable" data-export-title="<?php echo $this->lang->line('admission') . " " . $this->lang->line('report'); ?>">
                                ...
                                if (!empty($resultlist)) {
                                    ...
                                    foreach ($resultlist as $key => $value) {
                                        if($old_class!=$value['class']."-".$value['section'])
                                        {
                                       ?>
                                       <!-- <tr>
                                        <td></td>
                                        <td><b><?php echo $value['class']."-".$value['section'];?></b></td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                                        ...
                                        <?php
                                        $old_class = $value['class']."-".$value['section'];
                                        $rw=1;
                                         } ?>
                                       <tr>
                                       <td><?php echo $rw;?></td>
