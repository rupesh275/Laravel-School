        ...
        <div class="box box-primary border0 mb0 margesection">
            ...
            <div class="">
                <ul class="reportlists">
                    ...
                    <?php
                        if ($this->rbac->hasPrivilege('class_wise_attendence_status', 'can_view')) {
                            ?>
                            <li class="col-lg-4 col-md-4 col-sm-6 <?php echo set_SubSubmenu('Reports/attendance/class_wise_attendence_status'); ?>"><a href="<?php echo site_url('report/class_wise_attendence_status'); ?>"><i class="fa fa-file-text-o"></i> <?php echo $this->lang->line('class') . " " . $this->lang->line('wise') . " " . $this->lang->line('attendance') . " " . $this->lang->line('report'); ?></a></li>
                            <?php
                        }
                    ?>
