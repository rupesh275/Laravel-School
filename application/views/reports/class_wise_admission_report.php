        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box removeboxmius">
                    ...
                    <form action="<?php echo site_url('report/class_wise_admission_report') ?>" method="post" class="" id="s">
                    ...
                    <div class="" id="transfee">
                        ...
                        <h3 class="box-title titlefix "><i class="fa fa-money"></i></h3><br>
                        <p></p>
                        </div>
                        <div class="box-header ptbnull">
                            <h3 class="box-title titlefix"><i class="fa fa-money"></i> <?php echo "Class Wise Admission Report For the Year ".$current_session; ?></h3>
                        </div>
                        ...
                        <table class="table table-striped table-bordered  table-hover " id="headerTable" data-export-title="<?php echo $this->lang->line('admission') . " " . $this->lang->line('report'); ?>">
                                ...
                                if (!empty($resultlist)) {
                                    ...
                                    foreach ($resultlist as $key => $value) {
                                        if($old_class!=$value['class'])
                                        {
                                       ?>
                                       <tr>
                                        <td></td>
                                        <td><b><?php echo $value['class'];?></b></td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
