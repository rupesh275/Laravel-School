        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box removeboxmius">
                    ...
                    <form action="<?php echo site_url('report/payroll_daily_wages_report') ?>" method="post" class="" id="s">
                    ...
                    <div class="" id="transfee">
                        <div class="box-body table-container">
                            ...
                            <table class="table table-striped table-bordered  table-hover " id="headerTable" data-export-title="<?php echo $this->lang->line('admission') . " " . $this->lang->line('report'); ?>">
                                <thead>
                                    <tr>
                                        <th colspan="30" style="text-align: center;font-size: 20px;"><?php echo $setting->name; ?></th>
                                    </tr>
                                    <tr>
                                        <th colspan="30" style="text-align: center;"><?php echo $setting->address; ?></th>
                                    </tr>
                                    <tr>
                                        <th colspan="30" style="text-align: center;">Original Bill/Supplementary Bill/Advance Salary Grants Bill for the Month of : <span style="padding-left: 180px;"><?php echo $month . " " . $year; ?></span> <span style="padding-left: 150px;"> </span></th>
                                    </tr>
                                    <tr>
                                        <th colspan="8" style="text-align: center;"></th>
                                        <th colspan="9" style="text-align: center;"><?php echo "Details of the Admissing"; ?></th>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td style="mso-number-format:General;text-align:right;"><b id="nett_hold"><?php echo number_format($net_hold,2,".",""); ?></b></td>
