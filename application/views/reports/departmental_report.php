        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box removeboxmius">
                    ...
                    <? /*?>
                    <form action="<?php echo site_url('report/departmental_report') ?>" method="post" class="" id="s">
                    ...
                    <div class="" id="transfee">
                        ...
                        <div class="box-header ptbnull">
                            <h3 class="box-title titlefix"><i class="fa fa-money"></i> <?php echo  "Departmental " . $this->lang->line('report')." For The Year ".$current_session; ?></h3>
                        </div>
                        <div class="box-body table-responsive">
                            ...
                            <table class="table table-striped table-bordered  table-hover " id="headerTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center"><?php echo "Promoted"; ?></th>
                                        <th class="text-center"><?php echo "Admission"; ?></th>
                                        <!-- <th class="text-center"><?php echo "Inactive"; ?></th> -->
                                        <th class="text-center"><?php echo "TC Taken"; ?></th>
                                        <th class="text-center"><?php echo "Students"; ?></th>
                                    </tr>
                                </thead>
                                <?php
                                $tc_data = $this->student_model->get_preprimary_details();
                                $rw=0;
                                $promoted=0;$admission=0;$tc=0;$total=0;$inactive=0;

                                while($rw<=2) {
                                ?>
                                <tr>
                                    <?php if($rw==0){ ?>
                                        <td class="text-center"><?php echo "Pre-Primary"; ?></td>
                                    <?php } elseif($rw==1){ ?>
                                        <td class="text-center"><?php echo "Primary"; ?></td>
                                    <?php } elseif($rw==2){ ?>
                                        <td class="text-center"><?php echo "Secondary"; ?></td>
                                    <?php } ?>
                                    <td class="text-center"><?php echo $tc_data[$rw][0]; $promoted +=$tc_data[$rw][0]; ?></td>
                                    <td class="text-center"><?php echo $tc_data[$rw][1]; $admission +=$tc_data[$rw][1];?></td>
                                    <!-- <td class="text-center"><?php echo $tc_data[$rw][2]; $inactive +=$tc_data[$rw][2];?></td> -->
                                    <td class="text-center"><?php echo $tc_data[$rw][2]; $tc +=$tc_data[$rw][2]; ?></td>
                                    <td class="text-center"><?php echo $tc_data[$rw][3]; $total +=$tc_data[$rw][3];?></td>
                                </tr>
                                <?php ++$rw; } ?>
                                <tr>
                                    <td class="text-center"><?php echo ""; ?></td>
                                    <td class="text-center "><b><?php echo $promoted; ?></b></td>
                                    <td class="text-center"><b><?php echo $admission;?></b></td>
                                    <!-- <td class="text-center"><b><?php echo $inactive;?></b></td> -->
                                    <td class="text-center"><b><?php echo $tc; ?></b></td>
                            ...
                            <table class="table table-striped table-bordered  table-hover " id="headerTable">
                                <thead>
                                    <tr>
                                        <th class="text-center"><?php echo "Total Students"; ?></th>
                                ...
                                <?php
                                $prePrimary = $this->student_model->getSchSectionForDeptmt($id = 1);
                                $primary = $this->student_model->getSchSectionForDeptmt($id = 2);
                                $secondary = $this->student_model->getSchSectionForDeptmt($id = 3);
                                ?>
                                <tr>
                            ...
                            <table class="table table-striped table-bordered  table-hover " id="headerTable2" data-export-title="<?php echo "Departmental " . $this->lang->line('report'); ?>">
                                <thead>
                                    <tr>
                                        <th class="text-center"><?php echo "Total Students"; ?></th>
                            ...
                            <table class="table table-striped table-bordered  table-hover" id="headerTable4">
                                ...
                                <?php
                                $studentAge = $this->student_model->getDepartmentalArrayOnAge();
