        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box removeboxmius">
                    ...
                    <form role="form" action="<?php echo site_url('report/sibling_report_brief') ?>" method="post" class="" id="class_search_form">
                    ...
                    <div class="">
                        ...
                        <div class="box-header ptbnull">
                            <h3 class="box-title titlefix"><i class="fa fa-money"> </i> <?php echo $this->lang->line('sibling') . " " . $this->lang->line('report'); ?> Brief</h3>
                        </div>
                        <div class="box-body table-responsive" id="transfee">
                        <div id="printhead">
                            <center>
                                <h5><?php echo $this->lang->line('sibling') . " " . $this->lang->line('report')." Brief";
                                $this->customlib->get_postmessage();
                                ?></h5>
                            </center>
                                </div>

                            <div class="download_label"><?php echo $this->lang->line('sibling') . " " . $this->lang->line('report')." Brief";
                                                        $this->customlib->get_postmessage();
                                                        ?></div>
                                    ...
                                    <?php if (empty($resultlist)) {    ?>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?php echo $student['sadmission_no'];?></td>
                                                <td><?php echo $student['sclass'] ." ".$student['sesection']; ?></td>
                                                <td><?php echo $student['sfirstname']." ".$student['slastname']; ?></td>
                                                <td><?php echo $student['sfather_name']; ?></td>
                                            </tr>
                                    <?php
                                            $count++;
                                        }
...
<script>
    ...
    function exportToExcel() {
        ...
        link.download = "sibling_report_brief.xls";
