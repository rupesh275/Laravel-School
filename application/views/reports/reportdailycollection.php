        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box removeboxmius">
                    ...
                    <form action="<?php echo site_url('studentfee/reportdailycollection') ?>"  method="post" accept-charset="utf-8">
                        <div class="box-body">
                        ...
                        if (isset($fees_data)) {
                            ...
                            <div class="" id="transfee">
                                <div class="box-header ptbnull">
                                    <h3 class="box-title titlefix"><i class="fa fa-users"></i> <?php echo $this->lang->line('daily_collection_report'); ?> From <?php echo $date_from?> To <?php echo $date_to ;?></h3>
                                </div>                              
                                <div class="box-body">
                                   <?php 
                                   if(!empty($fees_data)){
...
$(document).ready(function(){
  $('#collectionModal').modal({backdrop:'static', keyboard:false, show: false});
      ...
      $(document).on('click', '.fee_collection', function () {
        ...
        $.ajax({
            type: 'POST',
            url: baseurl + "studentfee/feeCollectionStudentDeposit",
