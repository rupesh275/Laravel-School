        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box removeboxmius">
                    ...
                    <form role="form" action="<?php echo site_url('report/class_wise_document_report') ?>" method="post" class="" id="class_search_form">
                    ...
                    <div class="">
                        ...
                        <div class="box-header ptbnull">
                            <h3 class="box-title titlefix"><i class="fa fa-money"> </i> <?php echo $this->lang->line('class') . " Wise Document " . $this->lang->line('report'); ?></h3>
                        </div>
                        <div class="box-body table-responsive" id="transfee">
                        <div id="printhead">
                            <center>
                                <h5><?php echo $this->lang->line('class') . " Wise Document " . $this->lang->line('report');
                                                        $this->customlib->get_postmessage();
                                                        ?></h5>
                            </center>
                                </div>

                            <div class="download_label"><?php echo $this->lang->line('class') . " Wise Document " . $this->lang->line('report');
                                                        $this->customlib->get_postmessage();
                                                        ?></div>
                            ...
                            <table class="table table-striped table-bordered table-hover" id="headerTable">
                                <thead>
                                    <tr>
                                        ...
                                        <?php foreach ($checklistresult as $key => $checkRow) {
                                        ?>
                                        <th class="text-center"><?php echo $checkRow['item_name']; ?></th>
                                        <?php  } ?>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <?php foreach ($checklistresult as $key => $checkRow) {
                                                    ...
                                                    $docStatus = $this->db->where('checklist_id',$checkRow['id'])->get('student_checklist')->row_array();
                                                    if (!empty($docStatus)) {


                                                        if($docStatus['status'] == 'Submitted')
                                                        {$showStatus = 'Y'; }//'<i class="fa fa-check"></i>';}
                                                        // elseif($docStatus['status'] == 'Pending'){
                                                            // {$showStatus = 'N'; }
                                                        // }
                                                        else
                                                        {$showStatus = 'N'; } //'<i class="fa fa-remove"></i>';}
                                                    } else {
                                                        $showStatus = 'NR'; // '<i class="fa fa-remove"></i>';
                                                    }
                                                    
                                                ?>
                                                <td class="text-center" data-status="<?php echo $docStatus['status']; ?>"><?php echo $showStatus; ?></td>
                                                <?php  } ?>
                                            </tr>
                                    <?php
                                        }
...
<script>
    ...
    function exportToExcel() {
        ...
        link.download = "class_wise_document_report.xls";
