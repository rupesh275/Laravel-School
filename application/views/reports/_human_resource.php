                ...
                <ul class="reportlists">
                    ...
                    if (($this->rbac->hasPrivilege('payroll_report', 'can_view'))) {
                        ...
                        <li class="col-lg-4 col-md-4 col-sm-6 <?php echo set_SubSubmenu('Reports/attendance/attendance_report'); ?>">
                            <a href="<?php echo base_url(); ?>report/payrollreport"><i class="fa fa-file-text-o"></i> <?php echo $this->lang->line('payroll') . " " . $this->lang->line('report'); ?></a>
                        </li>
                    <?php }
                    if ($this->rbac->hasPrivilege('pf_report', 'can_view')) {
                        ?>
                        <li class="col-lg-4 col-md-4 col-sm-6 <?php echo set_SubSubmenu('Reports/human_resource/pf_report'); ?>">
                            <a href="<?php echo base_url(); ?>report/pf_report"><i class="fa fa-file-text-o"></i> <?php echo "PF " . $this->lang->line('report'); ?></a>
                        </li>
                    <?php } ?>
                </ul>
            </div>
