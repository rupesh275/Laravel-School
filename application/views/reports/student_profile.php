                ...
                <div class="box removeboxmius">
                    ...
                    <div class="">
                        ...
                        <div class="box-header ptbnull">
                            <h3 class="box-title titlefix"><i class="fa fa-money"></i> <?php echo $this->lang->line('student') . " " . $this->lang->line('profile'); ?> From <?php //echo date('d/m/Y',strtotime($start_date))." To ".date('d/m/y',strtotime($end_date)); ?></h3>
                        </div>
