        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box removeboxmius">
                    ...
                    <form role="form" action="<?php echo site_url('report/sibling_report_new') ?>" method="post" class="" id="class_search_form">
                    ...
                    <div class="" >
                        ...
                        <div id="printhead">
                            <center>
                                <h5><?php echo $this->lang->line('sibling') . " " . $this->lang->line('report');
                                $this->customlib->get_postmessage();
                                ?></h5>
                            </center>
                                </div>
                                <div class="download_label"><?php ?> <?php echo $this->lang->line('sibling') . " " . $this->lang->line('report');
                                                                        $this->customlib->get_postmessage();
                                                                        ?></div>
...
<script>
    ...
    function exportToExcel() {
        ...
        link.download = "sibling_report.xls";
