        ...
        <div id="invoice" class="effect2" style="position: relative; margin: 0 auto; width: 900px; background: #fff;">
            <div id="invoice-top" style="border-bottom: 1px solid #e82b45; min-height: 120px; padding: 30px 30px 0;">
                ...
                <div class="title text-right" style="text-align: center;">
                    ...
                    <p style="text-align: center; font-size: 15px; color: #666; line-height: 21px;"><b>AY <?php echo $session['session']; ?></b></p>
                    <h4> </h4>
                </div>
                <!--End Title-->
            </div>
            ...
            <div id="" style="padding: 0 30px 30px;">
                    ...
                    <table style="width: 100%;">
                        ...
                        ?>
                            ...
                            <?php $preamt = $total_paid - $total; ?>
                                            ...
                                            ?>
                            <td class="payment" style="text-align: right; padding: 5px 15px; border: 1px solid #eee;">
                                <h2 style="font-size:17px;"><b> <?php echo $currency_symbol . ' ' . number_format($receipt->prev_balance, 2); ?> </b></h2>
                            </td>
                            </tr>
                            <tr class="tabletitle" style="padding: 5px; background: #eee;">
                            <td colspan="2" style="text-align: right; padding: 5px 15px; border: 1px solid #eee;">
                            ...
                            <td class="payment" style="text-align: right; padding: 5px 15px; border: 1px solid #eee;">
                                <h2 style="font-size:17px;"><b> <?php echo $currency_symbol . ' ' . number_format($receipt->total_balance, 2); ?> </b></h2>
                            </td>
                            </tr>                            
                        <?php } ?>
                    </table>
                ...
                <div id="legalcopy" style="margin-top: 20px;">
                    <p class="legal" style="width: 70%; font-size: 15px; color: #666; ">
                        <strong><?php echo ucwords(markSheetDigitTwo($total)); ?> Rupees Only</strong>
                    </p>
                    
                    <p class="legal" style="width: 70%; font-size: 15px; color: #666; ">
                            <strong><b>Mode of Payment : <?php echo $payment_mode; ?></b></strong>
                        </p>                    
                    <?php if(!empty($cheque)) { if ($receipt->note == '') { ?>
                        <p class="legal" style="width: 70%; font-size: 15px; color: #666; ">
                            <strong><b>Chq.No : <?php echo $cheque['chq_no'] . ",Chq.Date : " . date('d-m-y', strtotime($cheque['chq_date'])) . " , Bank : " . $cheque['chq_bank'];  ?></b></strong>
                        </p>                    

                    <?php } } ?>
                    <?php if ($receipt->note!='') {   ?>
                        <p class="legal" style="width: 70%; font-size: 15px; color: #666; ">
                            <strong><b>Note : <?php echo $receipt->note; ?></b></strong>
                        </p>                    
                    <?php } ?>
                    <?php if ($payment_mode == 'gateway') {
                                ?>
                        <p class="legal" style="width: 70%; font-size: 15px; color: #666; ">
                            <strong><b>Note : Kindly note : If Gateway is aborted from your end after payment, a fine of Rs.500/- will be applicable and the Receipt will be considered as invalid</b></strong>
                        </p>                                 
                    <?php } ?>
