                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row pb-5 pl-3 pr-3">
                            <div class="w-50 pl-5 text-left">
                                <p class="font-weight-bold mb-4"><b> Student Name: </b><?php echo $this->customlib->getFullName($feearray[0]->firstname, $feearray[0]->middlename, $feearray[0]->lastname, $sch_setting->middlename, $sch_setting->lastname); ?></p>
                                <!-- <p class="mb-1"><b> INVOICE TO:</b> <?php //echo $invNo; ?></p> -->
                                <p class="mb-1"><b> Class:</b> <?php echo  $feearray[0]->class; ?></p>

                            </div>

                            <div class="w-50 pr-5 text-right">
                                <p class="font-weight-bold mb-4"><b> Reciept Date:</b><?php $date = date('d-m-Y'); echo date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($date));?></p>
                                <p class="mb-1"><b>Admission No. </b> <?php echo $feearray[0]->admission_no; ?></p>
                                <p class="mb-1"><b>Section </b> <?php echo $feearray[0]->section; ?></p>
