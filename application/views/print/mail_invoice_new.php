    ...
    <div id="invoiceholder" style="width: 100%; height: 100%;">
        ...
        <div id="invoice" class="effect2" style="position: relative; margin: 0 auto; width: 900px; background: #fff;">
            <table style="width:100%">
                <tr>
                    <td style="width:50%;padding:10px"><b class="text-uppercase" style="font-size:15px">
                    </td>
                    <td style="width:50%;text-align:right;padding:10px"><b class="text-uppercase" style="font-size:15px">
                        <b>C.B.S.E. Affliation No. </b>:<?php echo $settinglist['affilation_no']; ?><br>
                        <b> UDISE Code </b>:<?php echo $settinglist['school_UDISE']; ?>
                    </td>
                </tr>
            </table>
