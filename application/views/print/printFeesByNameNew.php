...
<body>
                    ...
                    <div class="card-body p-0">
                        ...
                        <div style="margin-left:30px;display:flex;justify-content: space-between; margin: 0;">
                            <div class="w-30 text-left">
                                ...
                                <div class="dflex dtitle">
                                    <p class="text-uppercase"><b> Receipt Date</b></p>: <b><?php echo $invDate; ?></b>
                                </div>
                            ...
                            <div class="w-40 text-right" style="margin-right: 19px;">
                                ...
                                <div class="text-uppercase dtitle" style="display:flex"><b> Academic Year :</b>
                                    <p style="width: 91px;"><?php if(!empty($receipt_session['session'])) echo $receipt_session['session']; ?> </p>
                                </div>
                            </div>
                        </div>
                        <div class="dflex dtitle">
                                ...
                                <table class="table">
                                    ...
                                    <?php if (!empty($feeList)) { ?>
                                        ...
                                        <tfoot>
                                            ...
                                            <td class="text-right content"><b> <?php echo $currency_symbol . ' '; echo number_format($total + $total_fine, 2); ?> </b></td>
                                        </tfoot>
                                        <tfoot>
                                            <td></td>
                                            <td class="text-right content"><b> Previous: </b></td>
                                            <?php $preamt = ($total_paid + $total_fine) - $total; ?>
                                            <?php
                                            if ($preamt > 0) {
                                                $prev_amt = $preamt;
                                            } else {
                                            ...
                                            ?>
                                            <td class="text-right content"><b> <?php echo $currency_symbol . ' ';
                                                                                echo number_format($prev_amt, 2); ?> </b></td>
                                        </tfoot>
                                    <?php } ?>
                                </table>
                            </div>
                        ...
                        <div class="d-flex" style="padding-bottom: 16px;">
                            <div class="col-6">
                                ...
                                ?>
                                    <p style="font-size: 17px;"><b>Note : Kindly note : If Gateway is aborted from your end after payment, a fine of Rs.500/- will be applicable and the Receipt will be considered as invalid</b></p>
    ...
    <div class="d-flex" style="justify-content:space-between;margin:0 20px;align-items: center;">
        ...
        <div>
            <p class="dtitle" style="font-size: 15px;"><b>Time  :</b><?php echo date('d-m-Y h:m:s', strtotime($receipt->created_at)); ?>
            </p>
        </div>
    </div>
</body>
