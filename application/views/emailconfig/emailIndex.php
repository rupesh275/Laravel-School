                           ...
                           <option value="<?php echo $smtp_auth_key?>" <?php echo set_select('smtp_security', $smtp_auth_key, (set_value('auth_key', $emaillist->smtp_auth) == $smtp_auth_key ) ? TRUE : FALSE ); ?> ><?php echo $smtp_auth_value;?></option>
                              <?php
                                   ...
                                   <?php echo $this->lang->line('status')?>
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  id="is_active" name="is_active" class="form-control col-md-7 col-xs-12">
                                            <option <?php if ($emaillist->is_active == "yes") { echo "selected";} ?> value="yes">Active</option>
                                            <option <?php if ($emaillist->is_active == "no") { echo "selected";} ?> value="no">Inactive</option>
                                        </select>
