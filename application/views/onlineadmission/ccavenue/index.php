            ...
            <div class="row">
                <div class="paddtop20">
                    <div class="col-md-8 col-md-offset-2 text-center">
                        ...
                        <img width ="20%" height="20%" src="<?php echo base_url('uploads/school_content/logo/' . $setting->image); ?>">
                    ...
                    <div class="col-md-6 col-md-offset-3 mt20">
                        <div class="paymentbg">
                           <div class="invtext"><?php echo $this->lang->line('payment_details'); ?> </div>
                            ...
                            <form action="<?php echo base_url(); ?>onlineadmission/ccavenue/pay" method="post">
                                    ...
                                    <table class="table2" width="100%">
                                        ...
                                        <tr class="border_bottom">
                                            <td> 
                                                 <span class="title"><?php echo "Total Fees"; ?></span></td>
                                        ...
                                        <tr class="bordertoplightgray">
                                            ...
                                            <td  bgcolor="#fff" class="text-right"> <button type="submit"  name="search"  value="" class="btn btn-success"> <?php echo $this->lang->line('pay_with_ccavenue'); ?> <i class="fa fa fa-chevron-right"></i></button>  </td>
                                        </tr>
                                    </table>
                                </form>
                            </div>
