                ...
                <div class="paddtop20">
                    ...
                    <div class="col-md-6 col-md-offset-3 mt20">
                        <div class="paymentbg">
                            ...
                            <!-- <form id="AWLPGPost" action="https://cgt.in.worldline-solutions.com/ipg/doMEPayRequest" method="POST"> -->
                                    <input type="hidden" name="merchantRequest" value="<?php echo $merchantRequest; ?>">
                                    <input type="hidden" name="MID" value="<?php echo $mid; ?>"> 
                                    <div>
                                            Are you sure to pay Rs.<?php echo $amount; ?>
                                    </div>
