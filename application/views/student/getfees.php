                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                ...
                                                if ($old_group != $fee_value->name) {
                                                    ?>
                                                        <td>
                                                            <input class="checkbox chkgrp" type="checkbox" name="fee_checkbox_selection" data-fee_master_id="<?php echo $fee_value->id ?>" data-fee_session_group_id="<?php echo $fee_value->fee_session_group_id ?>" data-fee_groups_feetype_id="<?php echo $fee_value->fee_groups_feetype_id ?>">
                                                        </td>
                                                        <td align="left"><?php echo $fee_value->name;
...
<script type="text/javascript">
    $(document).ready(function() {
        $(document).on('click', '.chkgrp', function() {
            var clname = ".grp_" + $(this).data('fee_master_id');
            //alert(clname);
