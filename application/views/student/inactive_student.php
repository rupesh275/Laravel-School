        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <form role="form" action="<?php echo site_url('student/inactivesearchvalidation') ?>" method="post" class="class_search_form">
                                ...
                                <div class="slide-row">
                                    ...
                                    <div class="slide-footer">
                                        <span class="pull-right buttons">
                                            ...
                                            ?>
                                                <a target="_blank" href="<?php echo base_url(); ?>student/edit/<?php echo $student['id'] ?>" class="btn btn-default btn-xs" data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
                ...
                success: function(response) { // your success handler
                    ...
                    if (!response.status) {
                        ...
                        table = $('.student-list').DataTable({
                            ...
                            "ajax": {
                                "url": baseurl + "student/inactivedtstudentlist",
                                "dataSrc": 'data',
                                "type": "POST",
