            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="pull-right box-tools impbtntitle">
                        ...
                        ?>
                        <?php if ($this->rbac->hasPrivilege('import_student', 'can_view')) { ?>
                            <a href="<?php echo site_url('student/import_update') ?>">
                                <button class="btn btn-primary btn-sm"><i class="fa fa-upload"></i> <?php echo $this->lang->line('import_student') . " Update"; ?></button>
                            </a>
                        <?php }
                        ?>
                    </div>
                                ...
                                <div class="around10">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input autofocus="" id="application_no" name="application_no" placeholder="" type="text" class="form-control" value="<?php echo set_value('application_no'); ?>" />
                                            ...
                                            <select name="session_id" id="session_id" class="form-control">
                                                    ...
                                                    ?>
                                                        <option value="<?php echo $value['id']; ?>" <?php
                                                                                            if (set_value('session_id') == $value['id']) {
                                                                                                echo "selected";
                                                                                            }
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="aadhar_name" name="aadhar_name" placeholder="" type="text" class="form-control" value="<?php echo set_value('aadhar_name'); ?>" />
                                        ...
                                        <div class="col-md-3 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <?php ?>
                                                <input type="text" id="place_of_birth" value="<?php echo set_value('place_of_birth'); ?>" name="place_of_birth" class="form-control">
                                        ...
                                        <div class="col-md-3 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <?php ?>
                                                <input type="text" id="disability" value="<?php echo set_value('disability'); ?>" name="disability" class="form-control">
                                        ...
                                        if ($sch_setting->mobile_no) { ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <?php ?>
                                                    <input type="text" id="sub_caste" value="<?php echo set_value('sub_caste'); ?>" name="sub_caste" class="form-control">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <?php ?>
                                                <input type="text" id="uid_no" value="<?php echo set_value('uid_no'); ?>" name="uid_no" class="form-control">
                                        ...
                                        <div class="col-md-3 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <?php ?>
                                                <input type="text" id="tc_no" value="<?php echo set_value('tc_no'); ?>" name="tc_no" class="form-control">
                                        ...
                                        <div class="col-md-3 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <?php ?>
                                                <input type="text" id="duplicate_tc_no" value="<?php echo set_value('duplicate_tc_no'); ?>" name="duplicate_tc_no" class="form-control">
                                        ...
                                        <div class="col-md-3 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <?php ?>
                                                <input type="text" id="disability_type" value="<?php echo set_value('disability_type'); ?>" name="disability_type" class="form-control">
                                        ...
                                        <div class="col-md-3 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <?php ?>
                                                <input type="text" id="disability_card_no" value="<?php echo set_value('disability_card_no'); ?>" name="disability_card_no" class="form-control">
                                ...
                                <div class="bozero">
                                    ...
                                    <div class="around10">
                                            ...
                                            if ($sch_setting->father_occupation) { ?>
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="father_annual_income" name="father_annual_income" placeholder="" type="text" class="form-control" value="<?php echo set_value('father_annual_income'); ?>" />
                                        ...
                                        <div class="row">
                                            ...
                                            if ($sch_setting->mother_occupation) { ?>
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="mother_annual_income" name="mother_annual_income" placeholder="" type="text" class="form-control" value="<?php echo set_value('mother_annual_income'); ?>" />
                                            ...
                                            <div class="col-md-1">
                                                    <div class="form-group">
                                                        <label for="exampleInputFile" style="font-size: 12px;"><?php echo " Status"; ?></label>
                                                        <div>
                                            ...
                                            <?php if ($sch_setting->mother_pic) { ?>
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="pan_no_father" name="pan_no_father" placeholder="" type="text" class="form-control" value="<?php echo set_value('pan_no_father'); ?>" />
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <div><input id="pan_no_mother" class="form-control" type='text' name='pan_no_mother' value="<?php echo set_value('pan_no_mother'); ?>" />
                                                    </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <div><input id="parent_aadhar_no" class="form-control" type='text' name='parent_aadhar_no' value="<?php echo set_value('parent_aadhar_no'); ?>" />
                                                    </div>
                                ...
                                <div class="around10">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input id="late_adm_discount" name="late_adm_discount" placeholder="" type="text" class="form-control " value="<?php echo set_value('late_adm_discount'); ?>" />
                                ...
                                <div class="panel box collapsed-box border0 mb0">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <!-- <div class="tshadow bozero">
                                            <h3 class="pagetitleh2">General Details</h3>
                                            <div class="around10">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="remark" id="remark" class="form-control">
                                                                ...
                                                                <option value="Scope For Improvement">Scope For Improvement</option>
                                                            </select>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input id="total_att" name="total_att" placeholder="" type="text" class="form-control" value="" />
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input id="student_att" name="student_att" placeholder="" type="text" class="form-control" value="" />
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $(document).on('change', '#section_id', function(e) {
            ...
            $.ajax({
                    type: "POST",
                    url: base_url + "student/getlastAdmNo",
                    data: {
                        'class_id': class_id,
