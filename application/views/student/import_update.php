        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-info" style="padding:5px;">
                    ...
                    <form action="<?php echo site_url('student/import_update') ?>" id="employeeform" name="employeeform" method="post" enctype="multipart/form-data">
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 pt20">
                                    <button type="submit" class="btn btn-info pull-right"><?php echo $this->lang->line('import_student')." Update"; ?></button>
                                </div>
