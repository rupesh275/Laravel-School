        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <form role="form" action="<?php echo site_url('student/searchphotovalidation') ?>" method="post" class="class_search_form">
                            ...
                            <div class="box-body box-profile">
                                ...
                                <ul class="list-group list-group-unbordered">
                                    ...
                                    <li class="list-group-item listnoback">
                                            ...
                                            <input class="filestyle form-control" type='file' name='file' id="file" size='40' />
...
<script type="text/javascript">
                ...
                success: function(response) { // your success handler
                    ...
                    if (!response.status) {
                        ...
                        table = $('.student-list').DataTable({
                            ...
                            "ajax": {
                                "url": baseurl + "student/dtstudentlistphoto",
                                "dataSrc": 'data',
                                "type": "POST",
    ...
    $(document).on("click", ".view_modal_photo", function() {
        var $this = $(this);
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('.img-circle').attr("src",baseurl + "/"+data.image);
    ...
    $("#form").on("submit", function(e) {
        e.preventDefault();
        $.ajax({
            url: baseurl + "student/save_student_photos",
            type: 'POST',
