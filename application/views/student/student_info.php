                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="class_id" id="class_id" class="form-control">
                                        ...
                                        ?>
                                                <option value="<?php echo $class['id']; ?>" <?php echo set_select('sch_section_id',$class['id'], isset($update['sch_section_id']) && $update['sch_section_id'] == $sch_section['id'] ? true : false ); ?>><?php echo $class['class']; ?></option>
                                        <?php
                                            }
                                        }
                                        ?>
