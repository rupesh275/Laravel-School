                ...
                <div class="tab-pane detail_view_tab" id="tab_2">
                    ...
                    ?>
                        ...
                        foreach ($resultlist as $student) {
                            $update = $this->student_model->student_pass_status($student['id']);
                            ...
                            <div class="carousel-row">
                                <div class="slide-row">
                                    <div id="carousel-2" class="carousel slide slide-carousel" data-ride="carousel">
                                        <div class="carousel-inner">
                                            <div class="item active">
                                                <a target="_blank" href="<?php echo base_url(); ?>student/view/<?php echo $student['id'] ?>">
                                    ...
                                    <div class="slide-content">
                                        <h4><a target="_blank" href="<?php echo base_url(); ?>student/view/<?php echo $student['id'] ?>"> <?php echo $this->customlib->getFullName($student['firstname'], $student['middlename'], $student['lastname'], $sch_setting->middlename, $sch_setting->lastname); ?></a></h4>
                                        <div class="row">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                            <li><a target="_blank" href="<?php echo base_url(); ?>student/view/<?php echo $student['id'] ?>" class="btn btn-default btn-xs" data-toggle="tooltip" title="<?php echo $this->lang->line('show'); ?>">
                                                    <i class="fa fa-reorder"></i>
                                                </a></li>
                                            <li><?php
                                                if ($this->rbac->hasPrivilege('student', 'can_edit')) {
                                                ?>
                                                    <a target="_blank" href="<?php echo base_url(); ?>student/edit/<?php echo $student['id'] ?>" class="btn btn-default btn-xs" data-toggle="tooltip" title="<?php echo $this->lang->line('edit') . "p"; ?>">
                                                        <i class="fa fa-pencil"></i>
                                                    </a>
                                                <?php
                                                } ?>
                                            </li>
                                            <li><? if ($this->rbac->hasPrivilege('collect_fees', 'can_add')) {
                                                ?>
                                                    <a target="_blank" href="<?php echo base_url(); ?>studentfee/addfee/<?php echo $student['id'] ?>" class="btn btn-default btn-xs" data-toggle="tooltip" title="" data-original-title="<?php echo $this->lang->line('add_fees'); ?>">
...
<script type="text/javascript">
    ...
    $(document).on('click', '.admission_mail_confirm', function() {
        var student_session_id = $(this).data('student_session_id');
        console.log(student_session_id);

        $.ajax({
            type: 'POST',
            url: base_url + "student/admission_mail_confirmation",
            data: {
                student_session_id: student_session_id,
            },
            dataType: "JSON",
...
//Create a new HTML document.
    ...
    function Popup1(data) {
        var frame1 = $('<iframe />');  // Create an iframe element
        frame1[0].name = "frame1";
        $("body").append(frame1);  // Append iframe to the body

        // Access the iframe document
        var frameDoc = frame1[0].contentWindow || frame1[0].contentDocument.document || frame1[0].contentDocument;

        // Open the document and write content
        frameDoc.document.open();
        frameDoc.document.write('<html>');
        frameDoc.document.write('<head>');
        frameDoc.document.write('<title>Print Preview</title>');
        // Optional: Add print-specific CSS for better formatting
        // frameDoc.document.write('<link rel="stylesheet" href="path_to_print_style.css">');
        frameDoc.document.write('</head>');
        frameDoc.document.write('<body>');
        frameDoc.document.write(data);  // The content you want to print
        frameDoc.document.write('</body>');
        frameDoc.document.write('</html>');
        frameDoc.document.close();
        ...
        setTimeout(function() {
            // Ensure iframe content is fully loaded and ready for printing
            var printWindow = frame1[0].contentWindow || frame1[0].contentDocument;

            // Check if iframe content is loaded
            printWindow.onload = function() {
                printWindow.focus();  // Focus the iframe
                printWindow.print();  // Trigger the print functionality

                // Remove the iframe from DOM after printing
                frame1.remove();
            };
...
<script>
    function myAlert() {
        alert('Cannot edit fees already added');
    }
</script>