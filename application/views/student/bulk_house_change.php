        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form id='form1' action="<?php echo site_url('student/bulk_house_change') ?>" method="post" accept-charset="utf-8">
                        <div class="box-body">
                            ...
                            <h4> <?php echo "Change House To"; ?></h4>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1"><?php echo "To House"; ?></label><small class="req"> *</small>
                                        <select id="house_id" name="house_id" class="form-control">
                                            <option value=""><?php echo $this->lang->line('select'); ?></option>
                                            <?php
                                            foreach ($houselist as  $house) {
                                            ?>
                                                <option value="<?php echo $house['id']; ?>" <?php if (set_value('house_id') == $house['id']) echo "selected=selected"; ?>><?php echo $house['house_name']; ?></option>
                                            <?php
                                            } ?>
                                        </select>
                                        <span class="text-danger"><?php echo form_error('house_id'); ?></span>
                                    </div>
                                </div>
                            </div>
                    ...
                    ?>
                        ...
                        <form action="<?php echo site_url("student/bulkHouseChange") ?>" method="post" accept-charset="utf-8" class="promote_forms">
                            <div class="box-body">
