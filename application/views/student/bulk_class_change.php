        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form id='form1' action="<?php echo site_url('student/bulk_class_change') ?>" method="post" accept-charset="utf-8">
                        <div class="box-body">
                            ...
                            <h4> <?php echo "Change Class " . $this->lang->line('section') . " To"; ?></h4>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1"><?php echo "To " . $this->lang->line('class'); ?></label><small class="req"> *</small>
                                        <select id="to_class_id" name="to_class_id" class="form-control">
                                            <option value=""><?php echo $this->lang->line('select'); ?></option>
                                            <?php
                                            foreach ($classlist as  $class) {
                                            ?>
                                                <option value="<?php echo $class['id']; ?>" <?php if (set_value('to_class_id') == $class['id']) echo "selected=selected"; ?>><?php echo $class['class']; ?></option>
                                            <?php
                                            } ?>
                                        </select>
                                        <span class="text-danger"><?php echo form_error('to_class_id'); ?></span>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1"><?php echo "To " . $this->lang->line('division'); ?></label><small class="req"> *</small>
                                        <select id="to_section_id" name="to_section_id" class="form-control">
                                            <option value=""><?php echo $this->lang->line('select'); ?></option>
                                        </select>
                                        <span class="text-danger"><?php echo form_error('to_section_id'); ?></span>
                                    </div>
                                </div>
                            </div>
                    ...
                    ?>
                        ...
                        <form action="<?php echo site_url("student/bulk_class_change_validation") ?>" method="post" accept-charset="utf-8" class="promote_forms">
                            <div class="box-body">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                ...
                                                ?>
                                                    ...
                                                    <input type="hidden" name="to_section_id" value="<?php echo $to_section_id; ?>">
                                                    <input type="hidden" name="to_class_id" value="<?php echo $to_class_id; ?>">
                                                    <tr>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        var class_promote_id = $('#to_class_id').val();
        var section_promote_id = '<?php echo set_value('to_section_id', 0) ?>';
    ...
    function getPromotedSectionByClass(class_id, section_id) {
        ...
        if (class_id != "") {
            ...
            $.ajax({
                ...
                dataType: "json",
                beforeSend: function() {
                    $('#to_section_id').addClass('dropdownloading');
                },
                success: function(data) {
                    $.each(data, function(i, obj) {
                        var sel = "";
                    ...
                    $('#to_section_id').append(div_data);
                },
                complete: function() {
                    $('#to_section_id').removeClass('dropdownloading');
                }
            });
        }
    }
    ...
    $(document).on('change', '#to_class_id', function(e) {
        $('#to_section_id').html("");
        var class_id = $(this).val();
