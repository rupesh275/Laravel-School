            ...
            <div class="col-md-12">
                <div class="box-body" style="padding-top:0;">
                    <div class="box-header">
                        <div class="row">
                            <div class="col-md-4">
                                <h3 class="box-title"><?php echo "Student Division Change"; ?></h3>
                            </div>
                            <div class="col-md-8">
                        ...
                        <!-- <form action="<?php //echo site_url('student/feesubmit') ?>" method="post" id="assign_form1113"> -->
                            ...
                            <div class="box box-primary">
                                <div class="box-header ptbnull">
                                    <h3 class="box-title titlefix"><?php echo " Student Division Change"; ?></h3>
                                ...
                                <div class="box-body">
                                    <div class="mailbox-messages ">
                                        ...
                                        <form action="<?php echo site_url('student/div_update')?>"  method="post">
                                            <div class="row">
                                                <div class="col-md-3">
                                                        ...
                                                        <select name="section_id" id="section_id" class="form-control">
                                                            ...
                                                            ?>
                                                                <option value="<?php echo $value['id']; ?>" <?php
                                                                                                            if (set_value('section_id') == $value['id']) {
                                                                                                                echo "selected";
                                                                                                            }
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="remark" name="remark" placeholder="" type="text" class="form-control " value="<?php echo set_value('remark'); ?>" />
