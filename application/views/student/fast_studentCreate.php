        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form id="form1" action="<?php echo site_url('student/fast_admission') ?>" id="employeeform" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                        <div class="">
                            <div class="bozero">
                                ...
                                <div class="around10">
                                    ...
                                    <div class="row">
                                        ...
                                        <!-- <div class="col-md-3 col-xs-12">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1"><?php echo "UID No"; ?></label>
                                                    <?php ?>
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <span class="text-danger" id="sibiling_section_id_error"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <span class="text-danger" id="sibiling_student_id_error"></span>
                            </div>
                        </div>
                    </div>
                </div>
