        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form id='form1' action="<?php echo site_url('student/bulk_division_change') ?>" method="post" accept-charset="utf-8">
                        <div class="box-body">
                            ...
                            <h4> <?php echo "Change " . $this->lang->line('section') . " To"; ?></h4>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select id="to_section_id" name="to_section_id" class="form-control">
                                            ...
                                            ?>
                                                <option value="<?php echo $section['id']; ?>" <?php if (set_value('to_section_id') == $section['id']) echo "selected=selected"; ?>><?php echo $section['section']; ?></option>
                                            <?php
                                            } ?>
                                        </select>
                    ...
                    ?>
                        ...
                        <form action="<?php echo site_url("student/bulk_div_change") ?>" method="post" accept-charset="utf-8" class="promote_forms">
                            <div class="box-body">
