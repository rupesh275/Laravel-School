                        ...
                        <form id="form1" action="<?php echo site_url('classes/edit/' . $id) ?>"  method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input autofocus="" id="code" name="code" placeholder="" type="text" class="form-control" value="<?php echo set_value('code', $vehroute[0]->code); ?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="sch_section_id" id="sch_section_id" class="form-control">
                                        ...
                                        <option value="<?php echo $sch_section['id'];?>" <?php
                                            if (set_value('sch_section_id', $vehroute[0]->sch_section_id) == $sch_section['id']) {
