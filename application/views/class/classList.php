                    ...
                    <div class="box box-primary">
                        ...
                        <form id="form1" action="<?php echo site_url('classes'); ?>" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('code'); ?></label><small class="req"> *</small>
                                    <input autofocus="" id="code" name="code" placeholder="" type="text" class="form-control" value="<?php echo set_value('code'); ?>" />
                                    <span class="text-danger"><?php echo form_error('code'); ?></span>
                                </div>
                                
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><?php echo "Sch Section"; ?></label><small class="req"> *</small>
                                    <select name="sch_section_id" id="sch_section_id" class="form-control">
                                        <option value="">Select</option>
                                        <?php if (!empty($sch_section_result)) {
                                            foreach ($sch_section_result as  $sch_section) {
                                            ?>
                                        <option value="<?php echo $sch_section['id'];?>"><?php echo $sch_section['sch_section'];?></option>
                                        <?php }
                                        } ?>
                                    </select>
                            ...
                            <table class="table table-striped table-bordered table-hover example">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo $this->lang->line('code'); ?>
                                        </th>
                                        <th><?php echo "Sch Section"; ?>
                                        </th>
                                        <th><?php echo $this->lang->line('division'); ?>
                                        </th>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="mailbox-name">
                                                <?php echo $vehroute->code; ?>

                                            </td>
                                            <?php $sch_sectionbyid      = $this->classsection_model->getbyid_sch($vehroute->id);?>
                                            <td class="mailbox-name">
                                                <?php echo !empty($sch_sectionbyid['sch_section']) ? $sch_sectionbyid['sch_section'] :""; ?>
