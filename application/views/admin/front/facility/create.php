...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            <form id="form1" action="<?php echo site_url('admin/front/facility/create') ?>" enctype="multipart/form-data" id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                <div class="col-md-9">
                    <!-- Horizontal Form -->
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><?php echo $this->lang->line('add_facility'); ?></h3>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $(document).on('click', '.add_media', function (event) {
            ...
            var content = "";
            if (popup_target === "attachment_images") {
                
            }
            else if (popup_target === "media_images") {
...
/*
        $(document).on('click', '.add_attachment', function (event) {
            var content_html = $('div#media_div').find('.fadeoverlay.active').find('attachment').data('img');
            var is_image = $('div#media_div').find('.fadeoverlay.active').find('attachment').data('is_image');
            var content_name = $('div#media_div').find('.fadeoverlay.active').find('attachment').data('content_name');
            var content_type = $('div#media_div').find('.fadeoverlay.active').find('attachment').data('content_type');
            var vid_url = $('div#media_div').find('.fadeoverlay.active').find('attachment').data('vid_url');
            var content = "";
...
*/
    ...
    //for attachment
    function addAttachment(content_html) {
        $('.attachment_url').attr('src', content_html);
        $('#attachment').val(content_html);
        $('#attachment_preview').css("display", "block");
    }
    ...
    $(document).on('click', '.delete_attachemnt', function () {
        $('.attachment_url').attr('src', '');
        $('#attachment').val('');
        $('#attachment_preview').css("display", "none");
    });
