                ...
                <div class="col-md-4">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Add <?php if (!empty($title)) {
                                                            echo $title['name'];
                                                        } ?> Sub Subject </h3>
                        </div>
                        <form id="form1" action="<?php echo site_url('admin/subject/subsubject') ?>" id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group"><br>
                                    ...
                                    <input id="short_name" name="short_name" placeholder="" type="text" class="form-control" value="<?php echo set_value('short_name'); ?>" />
                                    <span class="text-danger"><?php echo form_error('short_name'); ?></span>
                                </div>
                                <div class="form-group"><br>
                                    <label for="exampleInputEmail1">Long Name</label>
                                    <input id="long_name" name="long_name" placeholder="" type="text" class="form-control" value="<?php echo set_value('long_name'); ?>" />
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td class="mailbox-date pull-right no-print">
                                                    <a data-placement="left" href="<?php echo base_url(); ?>admin/subject/subsubject/<?php echo $subject['id'] ?>" class="btn btn-default btn-xs" data-toggle="tooltip" title="SubSubject">
