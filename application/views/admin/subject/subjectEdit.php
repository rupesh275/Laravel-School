                    ...
                    <div class="box box-primary">
                        ...
                        <form action="<?php echo site_url("admin/subject/edit/" . $id) ?>" id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('subject') . " " . $this->lang->line('type'); ?></label>
                                    <select name="subject_type" id="subject_type" class="form-control">
                                        <option value="">Select</option>
                                        <option  value="Mark" <?php echo set_select('subject_type', 'Mark',( !empty($subject['SubjectType']) && $subject['SubjectType'] == "Mark" ? TRUE : FALSE )); ?>>Mark</option>
                                        <option  value="Grade" <?php echo set_select('subject_type', 'Grade',( !empty($subject['SubjectType']) && $subject['SubjectType'] == "Grade" ? TRUE : FALSE )); ?>>Grade</option>
                                    </select>
                                </div>
                            </div>
