                        ...
                        <form id="form1" action="<?php echo site_url('admin/feediscount') ?>" id="feediscountform" name="feediscountform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="feepercent" min="1" max="100" name="feepercent" type="number" class="form-control" value="<?php echo set_value('feepercent'); ?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="fees_type" id="fees_type" class="form-control">
                                        <option value="m">Main fees</option>
                                        <option value="o">Other fees</option>
                                ...
                                <div class="form-group">
                                    <input type="checkbox" name="date_enabled" id="date_enabled" value="1">
                                    <label for="exampleInputEmail1"><?php echo "Date Enabled"; ?></label>
                                    <span class="text-danger"></span>
                                </div>
                                <div class="form-group date_upt" style="display:none;">
                                    <label for="exampleInputEmail1"><?php echo "Date Upto"; ?></label>
                                    <input id="date_upto" name="date_upto" type="text" class="form-control date" value="<?php echo set_value('date_upto'); ?>" />
                                    <span class="text-danger"></span>
                                </div>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="mailbox-name">
                                                <?php if ($feediscount['fees_type'] == 'm') {
                                                    echo "Main Fees";
