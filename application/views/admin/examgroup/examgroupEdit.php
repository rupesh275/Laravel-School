                                ...
                                <div class="form-group">
                                    ...
                                    <select id="exam_type" name="exam_type" placeholder="" type="text" class="form-control">
                                        ...
                                        foreach ($examGroupType as $examType_key => $examType_value) {
                                            ?>
                                            <option value="<?php echo $examType_value['key']; ?>" data-id="<?php echo $examType_value['id']; ?>" <?php echo $examgroup->exam_type_id == $examType_value['id'] ? 'selected' :""; ?> ><?php echo $examType_value['name']; ?></option>
                                            <?php
                                        }
                                        ?>
                                    </select>
                                    <input type="hidden" name="examtype_id" value="<?php echo $examgroup->exam_type_id;?>" id="examtype_id">
                                    <span class="text-danger"><?php echo form_error('exam_type'); ?></span>
                                </div>
