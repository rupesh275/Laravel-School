<div class="content-wrapper" style="min-height: 946px;">
    ...
    <section class="content">
        <div class="row">
            <?php
            if ($this->rbac->hasPrivilege('exam_category', 'can_add')) {
                ?>
                <div class="col-md-4">
                    <div class="box box-primary">
                        ...
                        <form action="<?php echo site_url('admin/examgroup/exam_category') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Exam Category </label><small class="req"> *</small>
                                    <input autofocus="" id="exam_category" name="exam_category" placeholder="" type="text" class="form-control"  value="<?php echo set_value('exam_category'); ?>" />
