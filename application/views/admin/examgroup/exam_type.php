<div class="content-wrapper" style="min-height: 946px;">
    ...
    <section class="content">
        <div class="row">
            <?php
            if ($this->rbac->hasPrivilege('exam_type', 'can_add')) {
                ?>
                <div class="col-md-4">
                    <div class="box box-primary">
                        ...
                        <form action="<?php echo site_url('admin/examgroup/exam_type') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <!-- <input autofocus="" id="status" name="status" placeholder="" type="text" class="form-control"  value="<?php echo set_value('status'); ?>" /> -->
                                        ...
                                        <tr>
                                            ...
                                            <td class="mailbox-date pull-right">
                                                ...
                                                if ($this->rbac->hasPrivilege('exam_type', 'can_delete')) {
                                                    ?>
                                                    <a data-placement="left" href="<?php echo base_url(); ?>admin/examgroup/delete_examType/<?php echo $examtype['id'] ?>"class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('Exam Type will  delete this action is irreversible --r');">
