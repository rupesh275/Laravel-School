...
<?php if($staff['user_type']=='Teacher'){ ?>
           ...
           <div class="col-md-9">
                <div class="nav-tabs-custom theme-shadow">
                    ...
                    <li class="pull-right"><a href="javascript:void(0);" class="printInv" data-staff_id="<?php echo $id; ?>" data-toggle="tooltip" data-placement="bottom" title="<?php echo $this->lang->line("print"); ?>" title="<?php echo $this->lang->line('print'); ?>" class="text-light" ><i class="fa fa-print"></i></a></li>
