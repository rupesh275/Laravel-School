                        ...
                        <form id="form1" action="<?php echo site_url('admin/leavetypes/createLeaveType') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8"  enctype="multipart/form-data">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description" id="description" class="form-control" cols="30" rows="3"><?php
                                    if (isset($result)) {
                ...
                <div class="box box-primary" id="tachelist">
                    <div class="box-header ptbnull">
                        ...
                        <div class="box-tools pull-right">
                            <a href="<?php echo base_url(); ?>admin/leavetypes/leavetypecategorylist" class="btn btn-sm btn-primary" >Show All Leavetype Category</a>
                        </div>
                    </div>
                    <div class="box-body">
                                    ...
                                    foreach ($leavetype as $value) {
                                     ...
                                     <!--        <td><?php echo $this->lang->line($value['is_active']) ?></td>
                                            -->       <td class="mailbox-date pull-right no-print">
                                                <a data-placement="left" href="<?php echo base_url(); ?>admin/leavetypes/leavetype_category/<?php echo $value['id'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo "Leave Type Category"; ?>">
