            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            <form role="form" action="<?php echo site_url('admin/staff/staff_addition_validation') ?>" method="post" class="">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="add_date" id="add_date" value="<?php echo set_value('add_date', !empty($update['add_date']) ? date('d-m-Y', strtotime($update['add_date'])) : date('d-m-Y')) ?> " class="form-control date">
                                        <span class="text-danger"><?php echo form_error('add_date'); ?></span>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label> Amount</label><small class="req"> *</small>
                                        <input type="text" name="add_amount" id="add_amount" value="<?php echo set_value('add_amount', !empty($update['add_amount']) ? $update['add_amount'] : ""); ?>" class="form-control">
                                        <span class="text-danger"><?php echo form_error('add_amount'); ?></span>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="add_type" id="add_type" class="form-control">
                                            ...
                                            ?>
                                                    <option value="<?php echo $deductRow['id']; ?>" <?php echo set_select('add_type', $deductRow['id'], (!empty($update['add_type']) && $update['add_type'] == $deductRow['id'] ? TRUE : FALSE)) ?>> <?php echo $deductRow['name']; ?></option>
                                            <?php
                                                }
                                            } ?>
                                        </select>
                                        <span class="text-danger"><?php echo form_error('add_type'); ?></span>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
            ...
            <div class="col-md-12">
                <div class="box box-primary" id="sublist">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix"><?php echo "Staff Addition List"; ?></h3>
                    </div>
                    <div class="box-body">
                    <form id="form1" action="<?php echo base_url(); ?>admin/staff/staff_addition" method="post" accept-charset="utf-8">
                        <div class="box-body">
                                                            <div class="row">
                        ...
                        <div class="table-responsive mailbox-messages">
                            <div class="download_label"><?php echo "Staff Addition List"; ?></div>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td class="mailbox-name"><?php echo date('d-m-Y', strtotime($staffRow['add_date'])) ?></td>
                                                <td class="mailbox-name"><?php echo $staffRow['add_amount'] ?></td>
                                                <td class="mailbox-name"><?php echo $staffRow['addition_name'] ?></td>
                                                <td class="mailbox-date pull-right no-print">
                                                    <?php
                                                    if ($this->rbac->hasPrivilege('staff_addition', 'can_edit')) {
                                                    ?>
                                                        <a data-placement="left" href="<?php echo base_url(); ?>admin/staff/staff_addition/<?php echo $staffRow['id'] ?>" class="btn btn-default btn-xs" data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
                                                    ...
                                                    ?>
                                                        <a data-placement="left" href="<?php echo base_url(); ?>admin/staff/delete_addition/<?php echo $staffRow['id'] ?>" class="btn btn-default btn-xs" data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
