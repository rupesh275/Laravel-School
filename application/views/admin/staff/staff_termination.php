                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                            <!-- <small class="pull-right">
                                <?php if ($this->rbac->hasPrivilege('staff', 'can_add')) { ?> <a href="<?php echo base_url(); ?>admin/staff/create_termination" class="btn btn-primary btn-sm">
                                        <i class="fa fa-plus"></i> <?php echo $this->lang->line('add_staff') . " Termination"; ?>
                                    </a><?php } ?>
                            </small> -->
                        </div>
                    </div>
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="row">
                                    <form role="form" action="<?php echo site_url('admin/staff/staff_termination') ?>" method="post" class="">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a <?php if ($this->rbac->hasPrivilege('can_see_other_users_profile', 'can_view')) { ?> href="<?php echo base_url(); ?>admin/staff/profile/<?php echo $staff['id']; ?>" <?php } ?>><?php echo $staff['name'] . " " . $staff['surname']; ?>
                                                            </a>
                                                        </td>
                                                        ...
                                                        <td class="pull-right">
                                                            ...
                                                            $staff["role"];
                                                            if (($staff["role"] == "Super Admin") && $userdata["id"] == $staff["id"]) {
                                                                $a = 1;
                                                            ...
                                                            ?>
                                                                ...
                                                                <a href="<?php echo base_url() . "admin/staff/create_termination/" . $staff["id"] ?>" class="btn btn-primary pull-right btn-sm"></i>Terminate</a>
                                                                <a href="<?php echo base_url() . "admin/staff/cancel_termination/" . $staff["id"] ?>" class="btn btn-primary pull-right btn-sm"></i>Cancel</a>
                                                            <?php  } ?>
                                                        </td>
                                                    </tr>
                                            <?php
