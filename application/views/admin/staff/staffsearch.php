                    ...
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                            ...
                            <small style="padding-right: 5px;">
                                <a href="<?php echo base_url(); ?>admin/export/staffExport" class="btn btn-primary btn-sm">
                                    <i class="fa fa-file-excel-o"></i> <?php echo "Export"; ?>
                                </a>
                            </small>
                        </div>
                    </div>
                                                            ...
                                                            <div class="overlay3">
                                                                <div class="stafficons">
                                                                    ...
                                                                    ?>
                                                                        ...
                                                                        <a class="printInv" data-staff_id="<?php echo $staff['id']; ?>" title="<?php echo $this->lang->line('print'); ?>" href="javascript:void(0);"><i class=" fa fa-print"></i></a>
                                                                        <!-- <a title="<?php //echo $this->lang->line('export'); 
                                                                                        ?>"  href="<?php //echo base_url() . "admin/export/staffExport/" . $staff["id"] 
...
<script type="text/javascript">
    $(document).on('click', '.printInv', function() {
        ...
        $.ajax({
            url: '<?php echo site_url("admin/staff/printStaff") ?>',
            type: 'post',
            data: {
                'staff_id': staff_id,
            },
