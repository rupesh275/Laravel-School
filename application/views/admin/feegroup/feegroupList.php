                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input autofocus="" id="dis_name" name="dis_name" placeholder="" type="text" class="form-control" value="<?php echo set_value('dis_name'); ?>" />
                                    ...
                                    <?php  if ($userdata['role_id'] == 10 && $userdata['user_type'] == "Bus Operator" ) { ?>
                                        <option <?php echo set_value('fees_type'); ?>value="b">Bus Fees</option>
                                        <?php }else{?>
                                                <option <?php echo set_value('fees_type'); ?> value="m">Main Fees</option>
                                                <option <?php echo set_value('fees_type'); ?>value="o">Other Fees</option>
                                                <option <?php echo set_value('fees_type'); ?>value="b">Bus Fees</option>
                                        <?php }?>
                                            </select>
                                            <!-- <input autofocus="" id="name" name="name" placeholder="" type="text" class="form-control" value="<?php echo set_value('name'); ?>" /> -->
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <div id="input-type" class="row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <label class="radio-inline">
                                                            <input name="account_type" class="finetype" id="input-type-tutor" value="perday" type="radio" <?php echo set_radio('account_type', 'perday', (set_value('perday', $feegroup_type->fine_type) == "perday") ? TRUE : FALSE); ?> /><?php echo "Per " . $this->lang->line('day') ?>
                                                        </label>
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <label class="radio-inline">
                                                            <input name="account_type" class="finetype" id="input-type-tutor" value="permonth" type="radio" <?php echo set_radio('account_type', 'permonth', (set_value('permonth', $feegroup_type->fine_type) == "permonth") ? TRUE : FALSE); ?> /><?php echo "Per month" ?>
                                                        </label>
                                                    </div>                                                    
                                                </div>
                                            </div>
                            ...
                            <table class="table table-striped table-bordered table-hover example">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo "Display " . $this->lang->line('name'); ?></th>
