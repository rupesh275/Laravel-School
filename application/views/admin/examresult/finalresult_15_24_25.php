...
<body id="body">
    ...
    ?>
        ...
        <div class="" style="display:block;width:100%;padding-top:43px">
            <!-- <table class="bnone">
                <tr>
                    <td style="border:none">
                        <div class="" style="text-align:center;width:100%">
                            <p style="margin: 0px;font-size: 17px;font-size: 22px; font-family: system-ui; font-style: italic; color: #428133;padding-top: 13px;"><b>Annual Progress Report Card</b></p>
                ...
                for ($rw = 0; $rw < 2; ++$rw) { ?>
                    ...
                    <table class="table" style="margin-top:9px">
                        <tbody>
                            ...
                            ?>
                                    <tr class="bg">
                                        <th colspan="4" class="wt"><?php if (strcmp($subGroups[$rwg]->name, $subSubjects[0]->name) != 0) {
                                                                        echo $subGroups[$rwg]->name;
                                                                    } ?></th>
                                    </tr>
                                <?php }
        ...
        <div class="" style="display:flex;align-items: center;">
            <div class="w-50" style="">
                    ...
                    if (in_array($main_subjects[$rw]->name, $cocurriculam)) {
                        if ($subg == 0) { ?>
                            <table class="table" style="margin-top:9px">
                                <tbody>
                                    <tr>
                                        <th colspan='4' style="text-align:center;background-color: #7ba3c6ba;font-size: 14px;text-transform:capitalize;text-transform:uppercase"> <?php echo "Co-curricular Activities"; ?> </th>
                                    </tr>
                                    <tr class="bg">
                                        <th class="wt"></th>
                                        <th style="text-align:center">Evaluation 1</th>
                        ...
                        <table class="table" style="margin-top:5px">
                            <tbody>
                                ...
                                if ($main_subjects[$rw]->name != "Art Integrated Project") { ?>
                                    <tr>
                                        <th colspan='4' style="text-align:center;background-color: #7ba3c6ba;font-size: 14px;text-transform:uppercase"> <?php echo $main_subjects[$rw]->name; ?> </th>
                                    </tr>
                                    <tr class="bg">
                ...
                <div style="display:flex;justify-content:center; margin-top:25px;">
                    <table class="table  table3" style="width: 70%;">
                        <tr>
                            <th class="bg" style="width:32%;text-align:center">Grade</th>
            ...
            <div class="w-50" style="padding-top:2%;">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="" style="text-align:center;width:100%;">
                                    ...
                                    <h4 style="font-size: 16px;font-family: sans-serif;color: #00008b;font-weight: 700;">Academic Year: <b><?php echo $ay_year; ?></b></h4>
                                    <p></p>
                                </div>
                            </td>
                        </tr>
                    ...
                    <div>
                        <table class="bnone detail">
                            ...
                            <tr>
                                ...
                                <td><span style="padding-top: 7px;"><div style="display:flex;align-items: center;"><b style="font-size: 12px;margin-right: 5px;"> :</b><?php echo $student['roll_no']; ?></span></div></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><div style="display:flex;align-items: center;"><b style="font-size: 12px;margin-right: 5px;"> :</b><span><?php echo $total_att . ' / ' . $total_work_days; ?></span></div></td>
                            ...
                            <tr>
                                ...
                                <td style="width:30%"><div style="display:flex;align-items: center;"><b style="font-size: 12px;margin-right: 5px;"> :</b><span style="font-size: 14px;"><?php echo $principal[0]['name'] . " " . $principal[0]['middle_name'] . " " . $principal[0]['surname']; ?></span></div></td>
                                <th>Signature</th>
                                <td style="width:30%"><div style="display:flex;align-items: center;"><b style="font-size: 12px;margin-right: 5px;"> :</b><span></span></div></td>
                            </tr>
                            <tr>
                        ...
                        <table class="bnone detail">
                            <tr>
                                ...
                                <td style="width:30%"><div style="display:flex;align-items: center;"><b style="font-size: 12px;margin-right: 5px;"> :</b><span style="font-size: 14px;"><?php echo date('d-m-Y', strtotime($result_date['result_date'])); ?></div></td>
                                <th>School Seal</th>
                                <td></td>
