        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box removeboxmius">
                    ...
                    <div class="box-body">
                        <form role="form" action="<?php echo site_url('admin/examresult/subjectWiseMarksReport') ?>" method="post">
                                ...
                                <table class="table table-striped table-bordered table-hover datatable" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <?php
                                            if (!empty($mainsubjectList)) {
                                                foreach ($mainsubjectList as $subject_key => $subject_value) {
                                            ...
                                            ?>
                                                ...
                                                ?>
                                                    ...
                                                    <!-- <th><?php //echo $this->lang->line('grand') . " " . $this->lang->line('total'); 
                                                                ?></th>
                                                    <th><?php //echo $this->lang->line('percent') 
                                                        ?> (%)</th> -->
                                                    <?php
                                                    if ($exam_details->exam_group_type != "gpa") {
                                                    ?>
                                    ...
                                    <tbody>
                                        ...
                                        // echo "<pre>";
                                        // print_r ($student_list_array);
                                        // echo "</pre>";

                                        if (!empty($studentList)) {
                                            $rank_count = 1;
                                            foreach ($studentList as $student_list_value) {
                                                $max_marks = 0;
                                                $get_marks = 0;
                                        ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php
                                                        echo $student_list_value->session_roll_no; ?> </td>
                                                    <td><?php echo $student_list_value->admission_no; ?></td>
                                                    <td>
                                                        <a href="<?php echo base_url(); ?>student/view/<?php echo $student_list_value->student_id; ?>"><?php echo $student_list_value->firstname . " " . $student_list_value->middlename . " " . $student_list_value->lastname; ?>
                                                        </a>
                                                    </td>
                                                    <?php
                                                    $student_exam_id = $student_list_value->exam_group_class_batch_exam_student_id;
                                                    if (!empty($mainsubjectList)) {
                                                        foreach ($mainsubjectList as $subject_key => $subject_value) {
                                                            // $percentage_grade = ($student_list_value->get_marks * 100) / $student_list_value->max_marks;
                                                    ?>
                                                            <td> <?php echo ''; ?></td>
                                                    <?php
                                                        }
