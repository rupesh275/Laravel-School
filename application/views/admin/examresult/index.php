                                        ...
                                        <select id="session_id" name="session_id" class="form-control">
                                            ...
                                            ?>
                                                <option value="<?php echo $session['id'] ?>" <?php
                                                                                                ...
                                                                                                ?> <?php echo set_select('session_id', 'session_id', (($current_session == $session['id']) ? true : false)); ?>><?php echo $session['session'] ?></option>
                                            <?php
                                            }
                                            ?>
                                        </select>
                            ...
                            <div class="">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="tab-pane active table-responsive no-padding" id="tab_1">
                                        ...
                                        <table class="table table-striped table-bordered table-hover text-center example" cellspacing="0" width="100%">
                                            <thead>
                                                <tr>
                                                    ...
                                                    ?>
                                                            <th>
                                                                ...
                                                                $mainCount = $this->examresult_model->getCountSubject($subject_value->id);
                                                                $mainsub = $this->examresult_model->getsubject($subject_value->main_sub);
                                                                $subRowArray = $this->examresult_model->getsubject($subject_value->subject_id);
                                                ...
                                                ?>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo ($student_value->exam_roll_no != 0) ? $student_value->exam_roll_no : $student_value->roll_no; ?> </td>
                                                            <td>
