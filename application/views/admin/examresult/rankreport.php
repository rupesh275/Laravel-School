                    ...
                    <div class="box-body">
                        <form role="form" action="<?php echo site_url('admin/examresult/rankreport') ?>" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-lg-3 col-md-3 col20">
                                    <div class="form-group">
                                        <label><?php echo "Subject" ?></label><small class="req"> </small>
                                ...
                                <div class="col-sm-6 col-lg-3 col-md-3 col20">
                                    <div class="form-group">
                                        <label><?php echo "Marks Type" ?></label><small class="req"> </small>
                                        <select id="marks_type" name="marks_type" class="form-control">
                                            <option value="1" <?php if(set_value('marks_type')==1) {echo "selected=selected"; }?>><?php echo "Marks"; ?></option>
                                            <option value="2" <?php if(set_value('marks_type')==2) {echo "selected=selected"; }?>><?php echo "Grade"; ?></option>
                                            <option value="3" <?php if(set_value('marks_type')==3) {echo "selected=selected"; }?>><?php echo "Both"; ?></option>
                                        </select>
                                        <span class="text-danger"><?php echo form_error('marks_type'); ?></span>
                                    </div>
                                </div><!--./col-md-3-->
                            ...
                            <div class="table-responsive no-padding">
                                ...
                                <?php
                                    ...
                                    foreach ($studentList as $student_key => $student_value) {
                                        ...
                                        $student_array['profile_roll_no'] = ($student_value->session_roll_no != 0) ? $student_value->session_roll_no : "-";
                                        ...
                                        if (!empty($subjectList)) {
                                            ...
                                            foreach ($subjectList as $subject_key => $subject_value) {
                                                ...
                                                if ($result) {
                                                    ...
                                                    if($exam_details->mark_result==1)
                                                    {

                                                        $subject_result['get_marks'] = $result->final_mark;
                                                                ...
                                                                <td>
                                                                    ...
                                                                    if ($result_value['result_status']) {
                                                                        if ($exam_details->exam_group_type == "gpa") {
                                                                            ...
                                                                            if (!empty($marks_type) && $marks_type == 1) {
                                                                               $fullMark =  $result_value['get_marks'];
                                                                            } elseif(!empty($marks_type) && $marks_type == 2) {
                                                                                $fullMark =  $result_value['get_exam_grade'] == "-" ? "" : $result_value['get_exam_grade'];
                                                                            }elseif (!empty($marks_type) && $marks_type == 3) {
                                                                                $fullMark =  $result_value['get_marks'] . ($result_value['get_exam_grade'] == "-" ? "" : " (" . $result_value['get_exam_grade'] . ")");
                                                                            }else {
                                                                                $fullMark =  $result_value['get_marks'] . ($result_value['get_exam_grade'] == "-" ? "" : " (" . $result_value['get_exam_grade'] . ")");
                                                                            }
...
<script type="text/javascript">
    ...
    var main_sub = '<?php echo set_value('main_sub') ?>';
    ...
    getSubjectByExam(exam_id, main_sub);
    $(document).on('change', '#exam_id', function(e) {
        $('#main_sub').html("");
        var exam_id = $(this).val();
        getSubjectByExam(exam_id, 0);
    });
    ...
    function getSubjectByExam(exam_id,main_sub) {
        ...
        if (exam_id !== "") {
            ...
            $.ajax({
                type: "POST",
                url: base_url + "admin/examgroup/getMainSubjectByExam",
                data: {
                    'exam_id': exam_id
                },
                dataType: "json",
                ...
                success: function(data) {
                    $.each(data, function(i, obj) {
                        var sel = "";
                        if (main_sub == obj.main_sub) {
                            sel = "selected='selected'";
                        }

                        div_data += "<option value=" + obj.main_sub + " " + sel + ">" + obj.name + "</option>";
                    });
