            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <form role="form" action="<?php echo site_url('admin/report_card') ?>" method="post" class="row">
                            ...
                            <div class="col-sm-6 col-lg-4 col-md-4" style="margin-top: 30px;">
                            <div class="form-group">
                                    <input type="checkbox" name="partial_marksheet" id="partial_marksheet" <?php if (set_value('partial_marksheet') == 1) {echo "checked";}?> value="1">
                                    <label for="exampleInputEmail1"><?php echo "Partial Marksheet" ?></label><small class="req"> </small>
                            </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
                    ...
                    ?>
                        <form method="post" action="<?php echo base_url('admin/report_card/finalresult') ?>">
                            ...
                            <input type="hidden" name="marksheet_partial" id = "marksheet_partial" value="<?php echo $partial_marksheet; ?>">
                                    ...
                                    <table class="table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                                        ...
                                        <tbody id="get_student">
                                            ...
                                            ?>
                                                ...
                                                ?>
                                                    <tr>
                                                        <td class="text-center"><input type="checkbox" class="checkbox center-block" name="student_session_id[]" data-student_id="<?php echo $student_value->student_session_id; ?>" value="<?php echo $student_value->student_session_id; ?>"></td>
                                                        <td><?php echo $student_value->roll_no; ?></td>
                                                        <td><a href="<?php echo base_url(); ?>student/view/<?php echo $student_value->student_id; ?>"><?php echo $this->customlib->getFullName($student_value->firstname, $student_value->middlename, $student_value->lastname, $sch_setting->middlename, $sch_setting->lastname); ?></a></td>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $(document).on('change', '#session_id,#class_id,#section_id', function(e) {
            $('#get_student').empty();
        });
