...
<?php
    ...
    <div class="PageBrack" style="display:flex;padding-bottom:10px;">
        ...
        <?php $rw = 0;
                for ($rw = 0; $rw < 2; ++$rw) { 
                    $total_mark1 = 0;$total_mark2 = 0;$total_mark3 = 0;$total_mark4 = 0;$total_mark5 = 0;$total_mark6 = 0;
                    $max_mark1 = 0;$max_mark2 = 0;$max_mark3 = 0;$max_mark4 = 0;$max_mark5 = 0;$max_mark6 = 0;
                    $mark1_status = 0;$mark2_status = 0;$mark3_status = 0;$mark4_status = 0;$mark5_status = 0;$mark6_status = 0;
                    ?>
                    ...
                    <?php
                            ...
                            for ($rwg = 0; $rwg < sizeof($subGroups); ++$rwg) {
                                ...
                                for ($rws = 0; $rws < sizeof($subSubjects); ++$rws) {
                                    ...
                                    if(!empty($ev1_result)) {$total_mark1 += $ev1_result['get_marks'];}
                                    if(!empty($ev2_result)) {$total_mark2 += $ev2_result['get_marks'];}
                                    if(!empty($ev3_result)) {$total_mark3 += $ev3_result['get_marks'];}
                                    if(!empty($ev4_result)) {$total_mark4 += $ev4_result['get_marks'];}
                                    if(!empty($ev5_result)) {$total_mark5 += $ev5_result['get_marks'];}
                                    if(!empty($ev6_result)) {$total_mark6 += $ev6_result['get_marks'];}

                                    if(!empty($ev1_result['final_mark'])){
                                    if(!empty($ev1_result['get_marks'])){ if($ev1_result['get_marks']>0){ $mark1_status = 1;$max_mark1 += $ev1_subject['max_marks'];}
                                    elseif($ev1_result['final_mark']=="-" && $mark1_status == 0){$mark1_status = 2;}elseif($ev1_result['final_mark']=="Ab" && $mark1_status == 0){$mark1_status = 3;} }elseif($ev1_result['final_mark']=="-" && $mark1_status == 0){$mark1_status = 2;}elseif($ev1_result['final_mark']=="Ab" && $mark1_status == 0){$mark1_status = 3;}
                                    }
                                     
                                    if(!empty($ev2_result['final_mark'])){
                                    if(!empty($ev2_result['get_marks'])){ if($ev2_result['get_marks']>0){ $mark2_status = 1;$max_mark2 += $ev2_subject['max_marks'];}
                                    elseif($ev2_result['final_mark']=="-" && $mark2_status == 0){$mark2_status = 2;}elseif($ev2_result['final_mark']=="Ab" && $mark2_status == 0){$mark2_status = 3;}}elseif($ev2_result['final_mark']=="-" && $mark2_status == 0){$mark2_status = 2;}elseif($ev2_result['final_mark']=="Ab" && $mark2_status == 0){$mark2_status = 3;}
                                    }
                                    
                                    if(!empty($ev3_result['final_mark'])){
                                    if(!empty($ev3_result['get_marks'])){ if($ev3_result['get_marks']>0){ $mark3_status = 1;$max_mark3 += $ev3_subject['max_marks'];}elseif($ev3_result['final_mark']=="-" && $mark3_status == 0){$mark3_status = 2;}
                                    elseif($ev3_result['final_mark']=="Ab" && $mark3_status == 0){$mark3_status = 3;}}elseif($ev3_result['final_mark']=="-" && $mark3_status == 0){$mark3_status = 2;}elseif($ev3_result['final_mark']=="Ab" && $mark3_status == 0){$mark3_status = 3;}
                                    }

                                    if(!empty($ev4_result['final_mark'])){
                                    if(!empty($ev4_result['get_marks'])){ if($ev4_result['get_marks']>0){ $mark4_status = 1;$max_mark4 += $ev4_subject['max_marks'];}
                                    elseif($ev4_result['final_mark']=="-" && $mark4_status == 0){$mark4_status = 2;}elseif($ev4_result['final_mark']=="Ab" && $mark4_status == 0){$mark4_status = 3;}}elseif($ev4_result['final_mark']=="-" && $mark4_status == 0){$mark4_status = 2;}elseif($ev4_result['final_mark']=="Ab" && $mark4_status == 0){$mark4_status = 3;}
                                    }

                                    if(!empty($ev5_result['final_mark'])){
                                    if(!empty($ev5_result['get_marks'])){ if($ev5_result['get_marks']>0){ $mark5_status = 1;$max_mark5 += $ev5_subject['max_marks'];}
                                    elseif($ev5_result['final_mark']=="-" && $mark5_status == 0){$mark5_status = 2;}elseif($ev5_result['final_mark']=="Ab" && $mark5_status == 0){$mark5_status = 3;}}elseif($ev5_result['final_mark']=="-" && $mark5_status == 0){$mark5_status = 2;}elseif($ev5_result['final_mark']=="Ab" && $mark5_status == 0){$mark5_status = 3;}
                                    }

                                    if(!empty($ev6_result['final_mark'])){
                                    if(!empty($ev6_result['get_marks'])){ if($ev6_result['get_marks']>0){ $mark6_status = 1;$max_mark6 += $ev6_subject['max_marks'];}
                                    elseif($ev6_result['final_mark']=="-" && $mark6_status == 0){$mark6_status = 2;}elseif($ev6_result['final_mark']=="Ab" && $mark6_status == 0){$mark6_status = 3;}}elseif($ev6_result['final_mark']=="-" && $mark6_status == 0){$mark6_status = 2;}elseif($ev6_result['final_mark']=="Ab" && $mark6_status == 0){$mark6_status = 3;}
                                    }
                                ?>
                                    <tr>
        ...
        <?php $rw = 0;
            ...
            <table class="table" style="margin-top:9px">
                <tbody>
                    <?php if($rw==2) { ?>
                        <tr>
                        <th colspan='7' style="text-align:center;background-color:#9ac86f;font-size: 14px;"> C. Computer </th>
                    </tr>
                    <?php } ?>
                    <tr class="bg">
                        <th class="wt"><?php echo $main_subjects[$rw]->name; ?></th>
            ...
            <table class="table" style="margin-top:9px">
                <tbody>
                    <?php if($rw==6) { ?>
                        <tr>
                        <th colspan='7' style="text-align:center;background-color:#9ac86f;font-size: 14px;"> D. Creative and Expressive Arts </th>
                    </tr>
                    <?php } ?>
                    <tr class="bg">
                        <th class="wt"><?php echo $main_subjects[$rw]->name; ?></th>
            ...
            <table class="table" style="margin-top:9px">
                <tbody>
                    <?php if($rw==4) { ?>
                        <tr>
                        <th colspan='7' style="text-align:center;background-color:#9ac86f;font-size: 14px;">  E. Personality Development </th>
                    </tr>
                    <?php } ?>
                    <tr class="bg">
                        <th class="wt"></th>
            ...
            <table class="table" style="margin-top:9px">
                <tbody>
                    <?php if($rw==8) { ?>
                        <tr>
                        <th colspan='7' style="text-align:center;background-color:#9ac86f;font-size: 14px;">   F. Gross Motor Skill  </th>
                    </tr>
                    <?php } ?>
                    <tr class="bg">
                        <th class="wt"><?php echo $main_subjects[$rw]->name; ?></th>
            ...
            <table class="table" style="margin-top:9px">
                <tbody>
                    <?php if($rw==9) { ?>
                        <tr>
                        <th colspan='7' style="text-align:center;background-color:#9ac86f;font-size: 14px;">   G. Fine Motor Skill  </th>
                    </tr>
                    <?php } ?>
                    <tr class="bg">
                        <th class="wt"><?php echo $main_subjects[$rw]->name; ?></th>
            ...
            <table class="table" style="margin-top:9px">
                <tbody>
                    ...
                    <tr class="bg">
                        <th colspan="4" class="wt" style="text-align:center;background-color:#9ac86f;font-size: 14px;">Guidelines for assessment of graded subjects(D,E,F,G)</th>
                    </tr>
                    <tr>
        ...
        <div class="w-50">
            <table class="table" style="margin-top:5px">
                <tbody>
                    ...
                    <tr>
                        <td colspan='4' style="text-align:center;height: 22px;"><?php if(isset($remarks[0]['long_remarks'])) { echo $remarks[0]['long_remarks']; } ?></td>
                    </tr>
                    <tr>
                        <th colspan='4' style="text-align:center;background-color: #9ac86f;font-size: 14px;"> Evaluation 2 - General Remarks </th>
                    </tr>
                    <tr>
                        <td colspan='4' style="text-align:center;height: 22px;"><?php if(isset($remarks[1]['long_remarks'])) { echo $remarks[1]['long_remarks']; } ?></td>
                    </tr>
                    <tr>
                        <th colspan='4' style="text-align:center;background-color: #9ac86f;font-size: 14px;"> Evaluation 3 - General Remarks </th>
                    </tr>
                    <tr>
                        <td colspan='4' style="text-align:center;height: 22px;"><?php if(isset($remarks[2]['long_remarks'])) { echo $remarks[2]['long_remarks']; } ?></td>
                    </tr>
                    <tr>
                        <th colspan='4' style="text-align:center;background-color: #9ac86f;font-size: 14px;"> Evaluation 4 - General Remarks </th>
                    </tr>
                    <tr>
                        <td colspan='4' style="text-align:center;height: 22px;"><?php if(isset($remarks[3]['long_remarks'])) { echo $remarks[3]['long_remarks']; } ?></td>
                    </tr>
                    <tr>
                        <th colspan='4' style="text-align:center;background-color: #9ac86f;font-size: 14px;"> Evaluation 5 - General Remarks </th>
                    </tr>
                    <tr>
                        <td colspan='4' style="text-align:center;height: 22px;"><?php if(isset($remarks[4]['long_remarks'])) { echo $remarks[4]['long_remarks']; } ?></td>
                    </tr>
                    <tr>
                        <th colspan='4' style="text-align:center;background-color: #9ac86f;font-size: 14px;"> Evaluation 6 - General Remarks </th>
                    </tr>
                    <tr>
                        <td colspan='4' style="text-align:center;height: 22px;"><?php if(isset($remarks[5]['long_remarks'])) { echo $remarks[5]['long_remarks']; } ?></td>
                    </tr>
            ...
            <table class="table" style="margin-top:15px">
                       <tr>
                        <td colspan='4' style="width:60%">CONGRATULATION !!! PASSED & PROMOTED TO CLASS : </td>
                       <td><span style="font-weight: 800;font-size: 9px;"><?php echo $nextclass; ?></span></div> </td>
                    </tr>
                    <tr>
                        <td colspan='4'>NEW SESSION BEGINS ON : </td>
                        <td style="font-weight: 800;font-size: 9px;"><?php echo date('d-m-Y', strtotime($new_session['start_date'])); ?></td> 
                    </tr>
            </table>
            <?php } ?>
        ...
        <div class="w-50 FBG" style="padding-top:2%;">
            ...
            <div class="bnone achive W50BG2">
                <table style="width: 100%;">
                    <tr>
                        <td>
                            ...
                            <div class="BalWatika" style="text-align:center;width:100%;padding-left: 20px;">
                                    <h6>Seedlings - Balvatika</h6>
                                    <h2>REPORT CARD</h2>
                    ...
                    <table class="frontpage"  style="width:100%;height: 114px;">
                        <tbody>
                            <tr>
                                ...
                                <td colspan="3">  <div style="display:flex"><b style="font-size: 12px;"> :</b><span><?php echo $student['aadhar_name']; ?></span></div></td>
                            </tr>
                            <tr>
                                <th>Grade</th>
                                <td> <div style="display:flex"><b style="font-size: 12px;"> :</b><span><?php echo $student['code']; ?></span></div></td>
                                <th style="width:12%;text-align:right">Section</th>
                                <td style="    width: 30%;"> <div style="display:flex"><b style="font-size: 12px;"> :</b><span><?php echo $student['section']; ?></span></div></td>
                            </tr>
                            <tr>
                                    <th>Roll No</th>
                                    <td>
                ...
                <!-- <div class="d-flex Address">
                        <p>Residential Address</p> <div style="display:flex"><b style="font-size: 12px;"> :</b><span></span></div>
                    </div> -->
                <div>
                    <table class="frontpage" style="width:100%;height: 127px;">
                        <tbody>
                            <tr>
                                <th>Date Of Birth</th>
                                <td colspan="3"> <div style="display:flex"><b style="font-size: 12px;"> :</b><span><?php echo date('d-m-Y', strtotime($student['dob'])); ?></span></div></td>
                            </tr>
                            <tr>
                                <th style="width:25%;">Aadhaar Card No</th>
                                <td style="width:33%;"> <div style="display:flex"><b style="font-size: 12px;"> :</b><span><?php echo $student['adhar_no']; ?></span></div></div></td>
                                <th style="width:12%;text-align:right">Mobile No.</th>
                                <td> <div style="display:flex"><b style="font-size: 12px;"> :</b><span><?php echo $student['mobileno']; ?></span></div></div></td>
                            </tr>
                            <tr>
                            <th>Fathers Name</th>
                                    <td colspan="3">
                    ...
                    <table class="frontpage" style="width:100%;height:84px;">
                        <tbody>
                            <tr>
                                ...
                                <td>  <div style="display:flex"><b style="font-size: 12px;"> :</b><span><?php echo $student_session['height'] . " cm"; ?></span></div></td>
                                <th style="width:20%;text-align:right">Weight</th>
                                <td> <div style="display:flex"><b style="font-size: 12px;"> :</b><span><?php echo $student_session['weight'] . " kg"; ?></span></div></td>
                            </tr>
                            <tr>
                                <th>Blood Group</th>
                                <td> <div style="display:flex"><b style="font-size: 12px;"> :</b><span><?php echo $student['blood_group']; ?></span></div></td>
                                <th></th>
                                <td></td>
                            </tr>
                        </tbody>
                           ...
                           <table style="width:100%;height:42px">
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="width:36%;">
                                            <div style="display:flex"><b style="font-size: 12px;"> :</b><span><?php  echo $total_att; ///$student_session['student_att']; ?></span></div>
                                        </td>
                                        <th style="width: 22%;text-align: center;padding-left: 7px;">Total Working Days</th>
                                        <td>
                                            <div style="display:flex"><b style="font-size: 12px;"> :</b>
                                            <span><?php /*if ($student_session['total_att'] > 0) {
                            ...
                            <table style="width:100%;height:67px">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:20%;"><div style="display:flex"><b style="font-size: 12px;"> :</b><span ></span></div></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><div style="display:flex"><b style="font-size: 12px;"> :</b><span></span></div></td>
                                    </tr>
                                    <!-- <tr>
                            ...
                            <table style="width:100%;height:42px">
                                <tbody>
                                     <tr>
                                        ...
                                        <th style="width:14%;padding-left: 24px;">Date</th>
                                        <td style="width:20%;"><div style="display:flex"><b style="font-size: 12px;"> :</b><span><?php echo date('d-m-Y', strtotime($result_date['result_date'])); ?></span></div></td>
                                    </tr>
                                </tbody>
                            </table>
                            <table style="width:100%;height:42px">
                                <tbody>
                                     <tr>
                                        <th style="padding:0px;width:30%;"><br></th>
                                        <td><br></td>
                                        <th style="width:14%;padding-left: 24px;">School Seal</th>
                                        <td style="width:20%;"><div style="display:flex"><b style="font-size: 12px;"> :</b><br></div></td>
                                    </tr>
                                </tbody>
                            </table>
