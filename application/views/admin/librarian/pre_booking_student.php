    ...
    <section class="content">
        <div class="row">       
            ...
            <div class="box-header with-border">
                    ...
                    <div class="box-body">
                        <form role="form" action="<?php echo site_url('admin/member/pre_booking_student') ?>" method="post" class="row">
                                        ...
                                        foreach ($memberList as $member) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="mailbox-date pull-right">
                                                    <a href="<?php echo base_url(); ?>admin/member/pre_book/<?php echo $member['id'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo "Pre Book"; ?>">
