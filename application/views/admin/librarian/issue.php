            ...
            <div class="col-md-9">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <a class="btn btn-primary text-right" href="<?php echo base_url('admin/book/choose_book/'. $memberList->lib_member_id."/0");?>">Choose Book</a>
                        </div>
                    ...
                    <form id="form1" action="<?php echo site_url('admin/member/issue/' . $memberList->lib_member_id) ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                        ...
                        <div class="box-footer">
                            ...
                            <button type="submit" id=""  class="btn btn-info pull-right"><?php echo $this->lang->line('save'); ?></button>
                        </div>
                    </form>
                </div>
                <div class="box box-primary">
