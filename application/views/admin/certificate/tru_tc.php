                                    ...
                                    <tr>
                                        ...
                                        <td class="pull-right">
                                            ...
                                            if ($this->rbac->hasPrivilege('tru_tc', 'can_edit')) { 
                                                ...
                                                ?>
                                                <a style="vertical-align: middle"  class="label label-info btn-xs btn" href="<?php echo base_url(); ?>admin/certificate/trutc_register/<?php echo $value['id'] ?>"><?php echo "Select"; ?></a>
                                                <?php }}  ?>
...
<script type="text/javascript">
    ...
    $(document).on('click', '.stcount', function() {
