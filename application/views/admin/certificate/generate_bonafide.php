        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <form role="form" action="<?php echo site_url('admin/generatecertificate/generate_bonafide') ?>" method="post" class="">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select name="certificate_id" class="form-control">
                                            <option value=""><?php echo $this->lang->line('select'); ?></option>
                                            <option value="1" <?php if (set_value('certificate_id') == 1) echo "selected=selected" ?>>Sample Bonafide Certificate</option>
                                        </select>
    ...
    $(document).ready(function() {
        $(document).on('click', '.printSelected', function() {
            ...
            if (array_to_print.length == 0) {
                ...
                $.ajax({
                    url: '<?php echo site_url("admin/generatecertificate/generatemultiple_bonafide") ?>',
                    type: 'post',
                    dataType: "html",
                    data: {
...
<script type="text/javascript">
    ...
    function Popup(data,winload = false) {
        ...
        setTimeout(function() {
            ...
            // frame1.remove();
            if (winload == false) {
                window.location.href = '<?php echo site_url('admin/generatecertificate/bonafide') ?>';
            }
        }, 500);
