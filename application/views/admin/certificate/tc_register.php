                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3 col-lg-3 col-md-3 ">
                                    <div class="form-group" style="height: 50px;">
                                        ...
                                        <input type="hidden" id="main_id" name="id" value="<?php if (isset($update)) {
                                                                                    echo $update['id'];
                                                                                } ?>">
                                    </div>
                                ...
                                <div class="col-sm-4 col-lg-4 col-md-4 ">
                                    <div class="form-group" style="height: 50px;">
                                        ...
                                        <input type="text" name="first_adm_class" id="first_adm_class" class="form-control" value="<?php if (isset($update) && $update['first_adm_class'] != "") {
                                                                                                                                            echo $update['first_adm_class'];
                                                                                                                                        } ?>">
                                    </div>
                                ...
                                <div class="col-sm-4 col-lg-4 col-md-4 ">
                                    <div class="form-group" style="height: 50px;">
                                        ...
                                        <select autofocus="" id="passed_promoted" name="passed_promoted" class="form-control select2">
                                            <option value=""><?php echo $this->lang->line('select'); ?></option>
                                            <?php
                                            // print_r($classlist);die;
                                            foreach ($classlist as $class) {
                                            ?>
                                                <option value="<?php echo $class['id'] ?>" <?php
                                                                                            if (set_value('passed_promoted') == $class['id']) {
                                                                                                echo "selected=selected";
                                                                                            }
                                                                                            ?><?php echo set_select('passed_promoted', $class['id'], isset($update['passed_promoted']) && $update['passed_promoted'] == $class['id'] ? true : false); ?>><?php echo $class['class'] ?></option>
                                            <?php
                                            }
                                            ?>
                                        </select>
                                ...
                                <div class="col-sm-4 col-lg-4 col-md-4 ">
                                    <div class="form-group" style="height: 50px;">
                                        <label for="exampleInputEmail1"><?php echo "Last Class Studied"; ?></label>
                                        <input type="text" name="last_class" id="last_class" class="form-control" value="<?php if (isset($update)) {
                                                                                                                        echo  $update['last_class'];
                                                                                                                    }?>">
                                    </div>
                                    <span class="text-danger"><?php echo form_error('last_class'); ?></span>
                                    <div class="text-danger" id="error-last_class"></div>
                                </div>
                                <div class="col-sm-4 col-lg-4 col-md-4 ">
                                    <div class="form-group" style="height: 50px;">
                                        <label for="exampleInputEmail1"><?php echo "Remarks"; ?></label>
                                        <input type="text" name="remark" id="remark" class="form-control" value="<?php if (isset($update)) {
                                                                                                                        echo  $update['remark'];
                                                                                                                    }?>">
                                    </div>
                                    <span class="text-danger"><?php echo form_error('remark'); ?></span>
                                    <div class="text-danger" id="error-remark"></div>
                                </div>
...
<script type="text/javascript">
    ...
    if (isset($update)) { ?>
        ...
        getSectionByClass(<?php echo $update['class_id']; ?>, <?php echo $update['section_id']; ?>);
        // setTimeout(function() {
    ...
    $(document).on('change', '#student_id', function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                // console.log(data.sub_caste);
                var pob = $('#pob').val();
                var adm_date = $('#first_adm_class').val();
                var nationality = $('#nationality').val();
                var cast = $('#cast').val();
                if (adm_date =="") {
                    $('#first_adm_class').val(data.admission_date);
                }
                if (cast =="") {
                    $('#cast').val(data.cast+','+ data.sub_caste);
                }
                if (pob =="") {
    ...
    $("#form").on("submit", function(e) {
        e.preventDefault();
        $.ajax({
            url: "<?php echo site_url('admin/certificate/tc_register_valid') ?>",
            type: 'POST',
