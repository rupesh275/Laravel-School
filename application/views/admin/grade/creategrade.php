                        ...
                        <form id="form1" action="<?php echo site_url('admin/grade') ?>" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input  id="name" name="grade_system" placeholder="" type="text" class="form-control" value="<?php echo set_value('grade_system'); ?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input autofocus="" id="grade_remark" name="grade_remark" placeholder="" type="text" class="form-control"  value="<?php echo set_value('grade_remark'); ?>" />
