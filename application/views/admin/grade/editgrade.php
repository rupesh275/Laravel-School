                    ...
                    <div class="box box-primary">
                        ...
                        <form action="<?php echo site_url('admin/grade/edit/' . $id) ?>" id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label><?php echo "Grade System"; ?><small class="req"> *</small></label>
                                    <input id="name" name="grade_system" placeholder="" type="text" class="form-control" value="<?php echo set_value('grade_system', $editgrade['grade_system']); ?>" />
                                    <span class="text-danger"><?php echo form_error('grade_system'); ?></span>
                                </div>
                                ...
                                <div class="form-group">
                                    <label><?php echo $this->lang->line('grade') . " " . $this->lang->line('remark'); ?><small class="req"> *</small></label>
                                    <input autofocus="" id="grade_remark" name="grade_remark" placeholder="" type="text" class="form-control" value="<?php echo set_value('grade_remark', $editgrade['grade_remark']); ?>" />
                                    <span class="text-danger"><?php echo form_error('grade_remark'); ?></span>
                                </div>
                    ...
                    <div class="box-body">
                        ...
                        <div class="table-responsive mailbox-messages">
                            ...
                            <table class="table table-striped table-bordered table-hover">
                                <thead>
                                    <tr>
                                        <th width="25%"><?php echo $this->lang->line('exam') . " " . $this->lang->line('type'); ?></th>
                                        <th>
                                            <table width="100%">
                                                <tr>
                                                    <th width="10%"><?php echo $this->lang->line('grade') . " " . $this->lang->line('system'); ?></th>
                                                    <th width="16%"><?php echo $this->lang->line('grade_name'); ?></th>
                                                    <th width="25%"><?php echo $this->lang->line('percent_from') . " / " . $this->lang->line('upto'); ?></th>
                                                    <th width="20%"><?php echo $this->lang->line('grade') . " " . $this->lang->line('point'); ?></th>
                                                    <th width="20%"><?php echo $this->lang->line('grade') . " " . $this->lang->line('remark'); ?></th>
                                                ...
                                                <td class="mailbox-name">
                                                    <table width="100%">
                                                        ...
                                                        ?>
                                                                ...
                                                                <tr>
                                                                    <td width="12%" class="text-left"><?php echo $grade_value->grade_system ?></td>
                                                                    <td width="14%" class="text-left"><?php echo $grade_value->name ?></td>
                                                                    <td width="25%" class="text-left"><?php echo $grade_value->mark_upto . " " . $this->lang->line('to') . " " . $grade_value->mark_from; ?> </td>
                                                                    <td width="20%" class="text-left"><?php echo $grade_value->point ?> </td>
                                                                    <td width="10%" class="text-left"><?php echo $grade_value->grade_remark ?> </td>
                                                                    <td class="text-right">
