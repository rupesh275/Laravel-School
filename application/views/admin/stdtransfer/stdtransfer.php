            ...
            <div class="col-md-12">
                ...
                <?php } ?>
                    ...
                    ?>
                        ...
                        <form action="<?php echo site_url("admin/stdtransfer/promote") ?>" method="post" accept-charset="utf-8" class="promote_forms">
                        <div class="box-body">
                        ...
                        <div class="box-footer clearfix">
                            ...
                            ?>
                                ...
                                <button type="submit" class="btn btn-sm btn-primary pull-right"><?php echo $this->lang->line('promote'); ?></button>
                            <?php
                            }
                            ?>
                        </div>
