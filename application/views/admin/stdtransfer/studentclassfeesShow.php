...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="box-body">
            ...
            <?php */ ?>
            <div class="col-md-12">
                <form action="<?php echo site_url('admin/stdtransfer/feesubmit') ?>" method="post" id="assign_form1113">
                        ...
                        <div class="box-body">
                            <div class="mailbox-messages table-responsive">
                                    ...
                                    <tbody>
                                        ...
                                        if (!empty($fees_array)) {
                                            foreach ($fees_array as $fee) {
                                                $feegroup_type = $this->feesessiongroup_model->getFeesByGroup($fee['fees_group_id'],$promoted_session);
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                    <input type="hidden" name="student_session_id" value="<?php echo $student_session_ids; ?>">
                                    <input type="hidden" name="session_id" value="<?php echo $session_id; ?>">

                                        <?php
                                        if (!empty($feediscountList)) {
                                            foreach ($feediscountList as $feediscount) { //4
