        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <?php } ?>
                    ...
                    <form id='form1' action="<?php echo site_url('admin/stdtransfer/depromote_student') ?>" method="post" accept-charset="utf-8">
                        <div class="box-body">
                    ...
                    ?>
                        ...
                        <form action="<?php echo site_url("admin/stdtransfer/depromote_validation") ?>" method="post" accept-charset="utf-8" class="promote_forms">
                        <div class="box-body">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                ...
                                                ?>
                                                    ...
                                                    <input type="hidden" name="roll_no_<?php echo $student['id']; ?>" value="<?php echo $student['roll_no']; ?>">
                                                    <tr>
                        ...
                        <div class="box-footer clearfix">
                            ...
                            ?>
                                ...
                                <button type="submit" class="btn btn-sm btn-primary pull-right"><?php echo "Depromote"; ?></button>
                            <?php
                            }
                            ?>
                        </div>
