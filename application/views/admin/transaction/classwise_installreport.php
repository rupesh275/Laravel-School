        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box removeboxmius">
                    ...
                    <form action="<?php echo site_url('admin/transaction/classwise_installreport') ?>" method="post" accept-charset="utf-8">
                        <div class="box-body">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <input type="checkbox" name="includediv" id="includediv" checked >Division Wise</input>
                                        <span class="text-danger"><?php echo form_error('includediv'); ?></span>
                                    </div>                                    
                                </div>  
                            </div>
                                <div class="col-sm-12">
                        ...
                        ?>
                            ...
                            <div class="" id="transfee">
                                <div class="box-header ptbnull">
                                    <h3 class="box-title titlefix"><i class="fa fa-users"></i> <?php echo "Class Wise Installment Report As On ".date('d-m-Y',strtotime($asondate)); ?></h3>
                                </div>
                                <div class="box-body table-responsive">
                                    <div class="download_label"><?php
                                                                echo "Class Wise Fees Report as on : ".date('d-m-Y',strtotime($asondate))."<br>";
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-right"><?php if (!empty($total_disc1)) {
                                                                    $disc_amt1 = $total_disc1;
                                                                } else {
                                                                    $disc_amt1 = 0;
                                                                }
                                                        ...
                                                        <td class="text-right"><?php if (!empty($total_disc2)) {
                                                                    $paid_amt2 = $total_disc2;
                                                                } else {
                                                                    $paid_amt2 = 0;
                                                                }
                                                        ...
                                                        <td class="text-right"><?php if (!empty($total_disc3)) {
                                                                    $disc_amt3 = $total_disc3;
                                                                } else {
                                                                    $disc_amt3 = 0;
                                                                }
