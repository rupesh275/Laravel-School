        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box removeboxmius">
                    ...
                    <form action="<?php echo site_url('admin/transaction/classfees_report') ?>" method="post" accept-charset="utf-8">
                        <div class="box-body">
                            <?php echo $this->customlib->getCSRF(); ?>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1"><?php echo "Section"; ?><small class="req"> *</small></label>
                        ...
                        ?>
                            ...
                            <div class="" id="transfee">
                                <div class="box-header ptbnull">
                                    <h3 class="box-title titlefix"><i class="fa fa-users"></i> <?php echo "Class Wise Fees Report"; ?></h3>
                                </div>
                                    ...
                                    <table class="table table-striped table-hover" id="headerTable">
                                        ...
                                        <tbody>
                                            ...
                                            if (!empty($class_section_list)) {
                                                ...
                                                foreach ($class_section_list as $key => $class) {
                                            ...
                                            <tr class="box box-solid total-bg">
                                                ...
                                                <td><?php echo $this->lang->line('grand_total'); 
                                                    ?></td>
                                                <td class="text-right"><?php echo $totalgrand; 
                                                                        ?></td>
                                                <td class="text-right"><?php echo $totaldepositfee; 
                                                                        ?></td>
                                                <td class="text-right"><?php echo $totaldiscount; 
                                                                        ?></td>
                                                <td class="text-right"><?php echo $totalfine; 
                                                                        ?></td>
                                                <td class="text-right"><?php echo $totalbalance; 
                                                                        ?></td>
                                            </tr>
                                        <?php } ?>
                                        </tbody>
