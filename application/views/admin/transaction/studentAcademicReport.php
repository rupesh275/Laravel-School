            ...
            <div class="col-md-12">
                <div class="box removeboxmius">
                    ...
                    <form action="<?php echo site_url('admin/transaction/studentacademicreport') ?>" method="post" accept-charset="utf-8">
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <!-- <div class="col-md-4">
                                    <div class="form-group">
                                        <input id="prev_due" type="checkbox" <?php echo set_checkbox('prev_due', '1'); ?> name="prev_due" value="1">
                                        <label for="exampleInputEmail1"><?php echo "Previous Dues"; ?></label>
                                    </div>
                                </div> -->
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        ?>
                            <div class="" style="display: flex;justify-content: space-between;    padding: 0 15px;    align-items: center;">
                                <div class="text-right box-header">
                                    <h3 class="box-title"><?php echo $this->lang->line('balance_fees_report'); ?> As On <?php echo date('d/m/Y');?></h3>
                                </div>
                                        ...
                                        <table class="table table-striped table-hover" id="headerTable">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <?php // } 
                                                    ?>
                                                    <th class="text-right"><?php echo "Previous Dues"; ?> <span><?php echo "(" . $currency_symbol . ")"; ?></span></th>
                                            ...
                                            <tbody>
                                                ...
                                                if (!empty($resultarray)) {
                                                    ...
                                                    $grand_balance = array();
                                                    // $grand_total=array();
                                                    // $previousfees           = $this->studentfeemaster_model->getPreviousStudentFees($student_session_id);
                                                    // echo "<pre>";
                                                    // print_r ($resultarray);
                                                    // echo "</pre>";
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <table><?php foreach ($name as $detail) { ?>
                                                                                <tr>
                                                                                    <td class="" style="width: 698px;"><?php echo $detail; ?></td>
                                                                                <tr>
                                                                                <?php }
                                                                                ?>
                                                                        </table>
                                                                    ...
                                                                    <td>
                                                                        <table><?php foreach ($admission_no as $admission_detail) { ?>
                                                                                <tr>
                                                                                    <td class=""><?php echo $admission_detail; ?></td>
                                                                                <tr>
                                                                                <?php }
                                                                                ?>
                                                                        </table>
                                                                    ...
                                                                    <!-- <td>
                                                                        <table><?php //foreach ($father_name as $father_name_detail) { 
                                                                                ?>
                                                                                <tr>
                                                                                    <td class=""><?php //echo $father_name_detail; 
                                                                                                    ?></td>
                                                                                <tr>
                                                                                <?php //}
                                                                                ?>
