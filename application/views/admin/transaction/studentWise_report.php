        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box removeboxmius">
                    ...
                    <form action="<?php echo site_url('admin/transaction/studentWise_report') ?>" method="post" accept-charset="utf-8">
                        <div class="box-body">
                        ...
                        ?>
                            ...
                            <div class="" id="transfee">
                                <div class="box-header ptbnull">
                                    <h3 class="box-title titlefix"><i class="fa fa-users"></i> <?php echo "Installment Wise Fees Report [".$class_name."-".$division . "]"; ?></h3>
                                </div>
                                <div class="box-body table-responsive">
                                    <div class="download_label"><?php
                                                                echo "Installment Wise Fees Report [".$class_name."-".$division . "]<br>";
                                    ...
                                    <table class="table table-striped table-bordered table-hover" class="display" style="width:100%" id="headerTable">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center" colspan="1">Prev.Dues</th>
                                                <th class="text-center" colspan="1">Installment -1</th>
                                                <th class="text-center" colspan="1">Installment -2</th>
                                                <th class="text-center" colspan="1">Installment -3</th>
                                                <th class="text-center" colspan="2">Net</th>
                                            ...
                                            <tr>
                                                ...
                                                <th class="text-center"><?php echo "Disc " . $this->lang->line('amount'); ?> <span><?php echo "(" . $currency_symbol . ")"; ?></span></th> -->
                                                <th class="text-center"><?php echo $this->lang->line('balance'); ?> <span><?php echo "(" . $currency_symbol . ")"; ?></span></th>
                                                <th class="text-center"><?php echo "Fine"; ?> <span><?php echo "(" . $currency_symbol . ")"; ?></span></th>
...
error_reporting(E_ALL);                                            
                                            ...
                                            if (!empty($students)) {
                                                ...
                                                foreach ($students as  $student) {
                                                    ...
                                                    $fine_status = $this->studentfee_model->get_current_month_fine_collection($student['student_session_id'],date('d-m-Y'));
                                                    if(!empty($prev_rec))
                                            ...
                                            ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center"><?php if ($student['session_is_active']  != "no"){ echo  "1"; } else { echo "0"; } ?></td>
                                                            <td class="text-right"><? echo $total_prev_dues; ?></td>                                                            
                                                            ...
                                                            <td class="text-right"><?php echo $balance;
                                                                ?></td>
                                                            <td class="text-right"><?php echo $fine_amt;
                                                                ?></td>                                                                
                                                            <td class="text-right"><?php echo $osamt; ?></td>
                                                            <td class="text-right"><? echo $total_prev_dues + $balance + $fine_amt ; ?></td> 
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right"><?php echo $netprevdues; ?></td>
                                                    ...
                                                    <td class="text-right"><?php echo $fee_fine_total; ?></td>                                                    
                                                    <!-- outstanding -->
                                                    <?php 
                                                    if ($netbalance <= 0) {
                                                       $os = 0;
                                                    ...
                                                    <td class="text-right"><?php echo round($netbalance + $netprevdues + $fee_fine_total , 2); ?></td>
                                                </tr>
                                                <tr>
                                                    <td></td>
