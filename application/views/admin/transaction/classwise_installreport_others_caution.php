        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box-header ptbnull"></div>
                    ...
                    <form action="<?php echo site_url('admin/transaction/classwise_installreport_others_caution') ?>" method="post" accept-charset="utf-8">
                        <div class="box-body">
                        ...
                        ?>
                            <div class="" id="transfee">
                                <div class="box-header ptbnull">
                                    <h3 class="box-title titlefix"><i class="fa fa-users"></i> <?php  echo "Caution Deposit Report as on ".date('d-m-Y',strtotime($asondate)); if($withinactive==1) { echo " With Inactive Students"; } ?></h3>
                                </div>
                                <div class="box-body table-responsive">
                                    <div class="download_label"><?php
                                                                echo "Caution Deposit Report as on ".date('d-m-Y',strtotime($asondate));  if($withinactive==1) { echo " With Inactive Students <br>"; } else { echo "<br>"; }
                                    ...
                                    <table class="table table-striped table-bordered table-hover" class="display" style="width:100%" id="headerTable">
                                        <thead>
                                            ...
                                            <tr>
                                                ...
                                                <th class="text-center"><?php echo "Caution Deposit"; ?></span></th>
                                                <th class="text-center"><?php echo "Paid Amount"; ?></span></th>
                                        ...
                                        <tbody>
                                            ...
                                            $net_fees = array('pay_amount' => 0,'paid_amount' => 0,'balance' => 0);
                                            if (!empty($classlist)) {
                                                foreach ($classlist as $stclass) 
                                                {
                                                    if($stclass['class_id']>=9 && $stclass['section_id'] > 0) {
                                                    $feetypeList = $this->feegrouptype_model->getmstbyclass_section($stclass['class_id'], $stclass['section_id']);
                                                    if($withinactive==1)
                                                    {$isactive='';}
                                                    else
                                                    {$isactive=1;}
                                                    $students = $this->student_model->getStudentByClassSectionIDforinstall_simple_all($stclass['class_id'], $stclass['section_id'],null,$isactive);
                                                ...
                                                foreach ($students as  $student) {
                                                    ...
                                                    $class_wise_dues = array('pay_amount' => 5000,'paid_amount' => 0,'balance_amount' => 0);
                                                    ...
                                                    if (!empty($student_total_fees)) {
                                                        ...
                                                        $inst_payamount = array(0, 0, 0);
                                                        $inst_paidamount = array(0, 0, 0);
                                                                        ...
                                                                        if (is_object($amount_detail)) {
                                                                            foreach ($amount_detail as $amount_detail_key => $amount_detail_value) {
                                                                                if($amount_detail_value->date <= $asondate) {
                                                                                    ...
                                                                                    if($each_fee_value->code == 'CAUTD') {
                                                                                        $class_wise_dues['paid_amount'] = $class_wise_dues['paid_amount'] +  $amount_detail_value->amount;
                                                                                    }
                                                                                }
                                                        ...
                                                        //if (($student['session_is_active']  == "yes") || (($student['session_is_active']  == "no") && ($withinactive==1))) {
                                                            if ($student['session_is_active']  == "no") {
                                                                ...
                                                                {++$active_cnt;}                                                            
                                                            ++$student_cnt;
                                                            $class_wise_dues['balance_amount'] = $class_wise_dues['pay_amount'] - $class_wise_dues['paid_amount'];
                                            ?>
                                                        <tr>
                                                            ...
                                                            <td class="text-right"><?php echo $class_wise_dues['pay_amount']; ?></td>
                                                            <td class="text-right"><?php echo $class_wise_dues['paid_amount']; ?></td>
                                                            <td class="text-right"><?php echo $class_wise_dues['balance_amount']; ?></td>                                                          
                                                        </tr>
                                                <?php
                                                $net_fees['pay_amount'] = $net_fees['pay_amount'] + $class_wise_dues['pay_amount'];
                                                $net_fees['paid_amount'] = $net_fees['paid_amount'] + $class_wise_dues['paid_amount'];
                                                $net_fees['balance_amount'] = $net_fees['balance_amount'] + $class_wise_dues['balance_amount'];
                                                }
                                                } //student rooll end
                                                } //student for end
                                                ?>
...
<tr>
                                                            ...
                                                            <td class="text-center"></td>
                                                                ...
                                                                <!-- 1st -->
                                                                <td class="text-right"><?php echo $net_fees['pay_amount']; ?></td>
                                                                <td class="text-right"><?php echo $net_fees['paid_amount']; ?></td>
                                                                <td class="text-right"><?php echo $net_fees['balance_amount']; ?></td> 
                                                            </tr>                                            
                                <?php }
                                        }
                                     ?>
