                        ...
                        ?>
                            ...
                            <div class="" id="transfee">
                                <div class="box-header ptbnull">
                                    ...
                                    <h3 class="box-title titlefix"><i class="fa fa-users"></i> <?php echo "Section Wise Fees Report as on ".date('d-m-Y'); ?></h3>
                                </div>
                                <div class="box-body table-responsive">
                                    <div class="download_label"><?php
                                                                echo "Section Wise Fees Report as on ".date('d-m-Y') . "<br>";
                                    ...
                                    <table class="table table-striped table-hover" class="display" style="width:100%" id="headerTable">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center" colspan="5">Installment -1</th>
                                                <th class="text-center" colspan="5">Installment -2</th>
                                                <th class="text-center" colspan="5">Installment -3</th>
                                                <th class="text-center" colspan="5">Net</th>
                                            </tr>
                                            <tr>
                                                <th class="text-left"><?php echo "Section"; ?></th>
                                                <th class="text-left"><?php echo $this->lang->line('pay') . " " . $this->lang->line('amount'); ?><span><?php echo "(" . $currency_symbol . ")"; ?></span></th>
                                            ...
                                            if (!empty($sch_section_result)) {
                                                ...
                                                ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <!-- 1st -->
                                                        <td class="text-right"><?php echo $grandPay1; ?></td>
                                                        <td class="text-right"><?php echo $grandPaid1; ?></td>
                                                        <td class="text-right"><?php echo $grandDisc1; ?></td>
                                                        <td class="text-right"><?php echo $grandBalance1; ?></td>
                                                        <td class="text-right"><?php 
                                                         if ($grandPay1 == 0) {
                                                            echo 0;
                                                        } else {
                                                        echo round(($grandBalance1 / $grandPay1) * 100, 2);
                                                        }
                                                         ?>%</td>
                                                        <!-- 2nd -->
                                                        <td class="text-right"><?php echo $grandPay2; ?></td>
                                                        <td class="text-right"><?php echo $grandPaid2; ?></td>
                                                        <td class="text-right"><?php echo $grandDisc2; ?></td>
                                                        <td class="text-right"><?php echo $grandBalance2; ?></td>
                                                        <td class="text-right"><?php
                                                                                if ($grandPay2 == 0) {
                                                                                    echo 0;
                                                                                } else {
                                                                                    echo round(($grandBalance2 / $grandPay2) * 100, 2);
                                                                                }
                                                                                ?>%</td>
                                                        <!-- 3rd -->
                                                        <td class="text-right"><?php echo $grandPay3; ?></td>
                                                        <td class="text-right"><?php echo $grandPaid3; ?></td>
                                                        <td class="text-right"><?php echo $grandDisc3; ?></td>
                                                        <td class="text-right"><?php echo $grandBalance3; ?></td>
                                                        <td class="text-right"><?php
                                                                                if ($grandPay3 == 0) {
                                                                                    echo 0;
                                                                                } else {
                                                                                    echo round(($grandBalance3 / $grandPay3) * 100, 2);
                                                                                }
                                                                                ?>%</td>
                                                        <!-- 4th -->
                                                ...
                                                <tr>
                                                    <td><b>Total</b></td>
                                                    <!-- 1st -->
                                                    <td class="text-right"><?php echo $grandPayTotal1; ?></td>
                                                    <td class="text-right"><?php echo $grandPaidTotal1; ?></td>
                                                    <td class="text-right"><?php echo $grandDiscTotal1; ?></td>
                                                    <td class="text-right"><?php echo $grandBalanceTotal1; ?></td>
                                                    <td class="text-right"><?php
                                                                            if ($grandBalanceTotal1 <= 0) {
                                                                                echo 0;
                                                                            } else {
                                                                                echo round(($grandBalanceTotal1 / $grandPayTotal1) * 100, 2);
                                                                            }
                                                                            ?>%</td>
                                                    <!-- 2nd -->
                                                    <td class="text-right"><?php echo $grandPayTotal2; ?></td>
                                                    <td class="text-right"><?php echo $grandPaidTotal2; ?></td>
                                                    <td class="text-right"><?php echo $grandDiscTotal2; ?></td>
                                                    <td class="text-right"><?php echo $grandBalanceTotal2; ?></td>
                                                    <td class="text-right"><?php
                                                                            if ($grandBalanceTotal2 <= 0) {
                                                                                echo 0;
                                                                            } else {
                                                                                echo round(($grandBalanceTotal2 / $grandPayTotal2) * 100, 2);
                                                                            }
                                                                            ?>%</td>
                                                    <!-- 3rd -->
                                                    <td class="text-right"><?php echo $grandPayTotal3; ?></td>
                                                    <td class="text-right"><?php echo $grandPaidTotal3; ?></td>
                                                    <td class="text-right"><?php echo $grandDiscTotal3; ?></td>
                                                    <td class="text-right"><?php echo $grandBalanceTotal3; ?></td>
                                                    <td class="text-right"><?php
                                                                            if ($grandBalanceTotal3 <= 0) {
                                                                                echo 0;
                                                                            } else {
                                                                                echo round(($grandBalanceTotal3 / $grandPayTotal3) * 100, 2);
                                                                            }
                                                                            ?>%</td>
                                                    <!-- 4th -->
