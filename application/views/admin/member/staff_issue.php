                                    ...
                                    <?php if (empty($teacherlist)) {
                                        ...
                                        foreach ($teacherlist as $teacher) {
                                            ...
                                            <tr class="<?php echo $clsactive; ?>">
                                                ...
                                                <a href="<?php echo base_url(); ?>admin/member/issue/<?php echo $teacher['libarary_member_id'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('issue_return'); ?>">
