...
<div class="content-wrapper" style="min-height: 946px;">
    ...
    <section class="content">
        ...
        <form action="<?php echo base_url('admin/feemaster/chq_passed') ?>" method="post">
                        ...
                        <div class="box-header with-border">
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <h3 class="box-title"><i class="fa fa-users"></i><?php echo "Cheque Passed"; ?></h3>
                                </div>
                                ...
                                <tbody>
                                    ...
                                    foreach ($resultlist as $value) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php /*
                                                if ($this->rbac->hasPrivilege('cheque_in_word', 'can_edit')) {
                                                ?>
