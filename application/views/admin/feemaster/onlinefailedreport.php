        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box removeboxmius">
                    ...
                    <form role="form" action="<?php echo site_url('admin/feemaster/onlinefailedreport') ?>" method="post" class="">
                    ...
                    <?php
                        ...
                        <div class="">
                            ...
                            <div class="box-header ptbnull">
                                <h3 class="box-title titlefix"><i class="fa fa-money"></i> <?php ?> <?php echo "Online Failed " . $this->lang->line('report'); ?> From <?php echo date('d/m/Y', strtotime($start_date)) . " To " . date('d/m/Y', strtotime($end_date)); ?></h3>
                            </div>
                            <div class="box-body table-responsive" id="transfee">
                                <div id="printhead">
                                    <center>
                                        <h4><?php ?> <?php echo "Online Failed " . $this->lang->line('report') . "<br>";
                                                        $this->customlib->get_postmessage();
                                                        ?></h4>
                                    </center>
                                </div>
                                <div class="download_label"><?php ?> <?php echo "Online Failed " . $this->lang->line('report') . "<br>";
                                                                        $this->customlib->get_postmessage();
                                                                        ?></div>
                                ...
                                <table class="table table-striped table-bordered table-hover " id="headerTable">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                <td><?php echo $i; ?> </td>
                                                <td><?php echo date('d-m-Y h:i:s', strtotime($value['trn_date'])); ?> </td>
                                                <td><?php echo $value['class']." ".$value['section']; ?> </td>
                                                <td><?php echo $value['roll_no']; ?> </td>
                                                <td><?php echo $value['firstname']." ".$value['lastname']; ?> </td>
                                                <td><?php echo $value['amount']; ?> </td>
                                                <td><?php echo $value['trn_status']; ?> </td>
                                            </tr>
                                        <?php
                                        $i++;
                                        }
...
<script>
    ...
    function printDiv() {
        ...
        document.body.innerHTML =
            "<html><head><title>Online Failed Report</title></head><body><h3 style='text-align:center;'>Sree Narayana Guru Central School</h3>" +
            divElements + "</body>";
        window.print();
    ...
    function exportToExcel() {
        ...
        link.download = "online_failed_report.xls";
