        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <form role="form" action="<?php echo site_url('admin/feemaster/assign_bus/' . $id) ?>" method="post" class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="vehroute_id">
                                        ...
                                        <?php
                                            ...
                                            ?>
                                                <option value="<?php echo $route['id']; ?>" <?php if (set_value('vehroute_id') == $route['id']) echo "selected=selected"; ?>><?php echo $route['route_title']; ?></option>
                                            <?php
                                            } ?>
                                    </select>
                                </div>
