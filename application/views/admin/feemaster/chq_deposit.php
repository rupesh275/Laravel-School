...
<div class="content-wrapper" style="min-height: 946px;">
    ...
    <?php $this->load->view('admin/feemaster/chq_menu');?>
        <form action="<?php echo site_url("admin/feemaster/chq_deposit") ?>" method="post" accept-charset="utf-8" class="promote_forms">
            <div class="row">
                <div class="col-md-12">
                        ...
                        <div class="box-header with-border">
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <h3 class="box-title"><i class="fa fa-users"></i><?php echo "Cheque Deposit"; ?></h3>
                                </div>
