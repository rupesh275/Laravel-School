                                        ...
                                        <tbody>
                                            ...
                                            foreach ($feemasterList as $feegroup) {
                                                if ($userdata['role_id'] == 10 && $userdata['user_type'] == "Bus Operator" ) {
                                                    ...
                                                    <a data-placement="top" href="<?php echo base_url(); ?>admin/feemaster/assign_class/<?php echo $feegroup->id ?>" class="btn btn-default btn-xs" data-toggle="tooltip" title="<?php echo "Assign / Class"; ?>">
                                                                <i class="fa fa-plus"></i>
                                                            </a>
                                                        <?php if ($this->rbac->hasPrivilege('fees_group_assign', 'can_view')) {
                                                            
                                                            if($feetype_value->code == "BF"){
                                                                $assignView = base_url('admin/feemaster/assign_bus/'.$feegroup->id);
                                                            } else{
                                                                $assignView = base_url('admin/feemaster/assign/'.$feegroup->id);
                                                            }
                                                            ?>
                                                            <a data-placement="top" href="<?php echo $assignView; ?>" class="btn btn-default btn-xs <?php echo $feetype_value->fee_groups_id; ?>" data-toggle="tooltip" title="<?php echo $this->lang->line('assign / view'); ?>">
                                                                <i class="fa fa-tag"></i>
                                                            </a>
                                                        <?php } ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="mailbox-date pull-right">
                                                        ...
                                                        if ($this->rbac->hasPrivilege('fees_group_assign', 'can_view')) { 
                                                            if($feetype_value->fee_groups_id == 39){
                                                                $assignView = base_url('admin/feemaster/assign_bus/'.$feegroup->id);
                                                            } else{
                                                                $assignView = base_url('admin/feemaster/assign/'.$feegroup->id);
                                                            }
                                                            ?>
                                                            <a href="<?php echo $assignView; ?>" 
