            ...
            if ($this->rbac->hasPrivilege('staff_deduction_type', 'can_add') || $this->rbac->hasPrivilege('staff_deduction_type', 'can_edit')) {
                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- form start -->
                        <form action="<?php echo site_url("admin/payroll/staff_deduction_type") ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                            ...
                                            <tr>                                               
                                                ...
                                                <td class="mailbox-date pull-right no-print">
                                                    ...
                                                    if ($this->rbac->hasPrivilege('staff_deduction_type', 'can_edit')) {
                                                        ...
                                                        <a data-placement="left" href="<?php echo base_url(); ?>admin/payroll/staff_deduction_type/<?php echo $result['id'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
                                                    ...
                                                    if ($this->rbac->hasPrivilege('staff_deduction_type', 'can_delete')) {
                                                        ?>
                                                        <a data-placement="left" href="<?php echo base_url(); ?>admin/payroll/delete_staff_deduction_type/<?php echo $result['id'] ?>"class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
