...
$staff = $this->staff_model->getstaff_session($staff_id);
                                            ...
                                            <table class="table mb0 font13">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo $staff["scale_of_pay"] ?> </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                    ...
                                    <div class="sameheight">
                                        <div class="feebox">
                                            ...
                                            <table class="table3" id="tableID">
                                                ...
                                                ?>
                                                    <!-- <tr id="row1">
                                                        <td><input type="text" class="form-control" id="allowance_type" name="allowance_type[]" value="Basic Pay"></td>
                                                        <td><input type="text" class="form-control" id="allowance_amount" name="allowance_amount[]" value="<?php echo $staff['basic_pay']; ?>"></td>
                                                        <td><button type="button" onclick="delete_row(1)" class='closebtn'><i class='fa fa-remove'></i></button></td>
                                                    </tr> -->
                                                    <tr id="row1">
                                                        <td><input type="text" class="form-control" id="allowance_type" name="allowance_type[]" value="GP"></td>
                                                        <td><input type="text" class="form-control" id="allowance_amount" name="allowance_amount[]" value="<?php echo $staff['gp']; ?>"></td>
                                                        <td><button type="button" onclick="delete_row(1)" class='closebtn'><i class='fa fa-remove'></i></button></td>
                                                    </tr>
                                                    <tr id="row2">
                                                        <td><input type="text" class="form-control" id="allowance_type" name="allowance_type[]" value="DA"></td>
                                                        <td><input type="text" class="form-control" id="allowance_amount" name="allowance_amount[]" value="<?php echo $staff['da']; ?>"></td>
                                                        <td><button type="button" onclick="delete_row(2)" class='closebtn'><i class='fa fa-remove'></i></button></td>
                                                    </tr>
                                                    <tr id="row3">
                                                        <td><input type="text" class="form-control" id="allowance_type" name="allowance_type[]" value="HRA"></td>
                                                        <td><input type="text" class="form-control" id="allowance_amount" name="allowance_amount[]" value="<?php echo $staff['hra']; ?>"></td>
                                                        <td><button type="button" onclick="delete_row(3)" class='closebtn'><i class='fa fa-remove'></i></button></td>
                                                    </tr>
                                                    <tr id="row4">
                                                        <td><input type="text" class="form-control" id="allowance_type" name="allowance_type[]" value="TA"></td>
                                                        <td><input type="text" class="form-control" id="allowance_amount" name="allowance_amount[]" value="<?php echo $staff['ta']; ?>"></td>
                                                        <td><button type="button" onclick="delete_row(4)" class='closebtn'><i class='fa fa-remove'></i></button></td>
                                                    </tr>
                                                    <tr id="row5">
                                                        <td><input type="text" class="form-control" id="allowance_type" name="allowance_type[]" value="Other Allowance"></td>
                                                        <td><input type="text" class="form-control" id="allowance_amount" name="allowance_amount[]" value="<?php echo $staff['other_allowance']; ?>"></td>
                                                        <td><button type="button" onclick="delete_row(5)" class='closebtn'><i class='fa fa-remove'></i></button></td>
                                                    </tr>
                                                    <tr id="row6">
                                                        <td><input type="text" class="form-control" id="allowance_type" name="allowance_type[]" value="Personal Profit"></td>
                                                        <td><input type="text" class="form-control" id="allowance_amount" name="allowance_amount[]" value="<?php echo $staff['personal_profit']; ?>"></td>
                                                        <td><button type="button" onclick="delete_row(6)" class='closebtn'><i class='fa fa-remove'></i></button></td>
                                                    </tr>
                                                <?php
                                                } ?>
                                            </table>
                                        ...
                                        <div class="feebox">
                                            <table class="table3" id="tableID2">
                                                ...
                                                <tr id="deduction_row1">
                                                    <td><input type="text" class="form-control" id="deduction_type" name="deduction_type[]" value="Provident Fund"></td>
                                                    <td><input type="text" class="form-control" id="deduction_amount" name="deduction_amount[]" value="<?php echo $staff['pf']; ?>"></td>
                                                    <td><button type="button" onclick="delete_deduction_row(1)" class='closebtn'><i class='fa fa-remove'></i></button></td>
                                                </tr>
                                                <tr id="deduction_row2">
                                                    <td><input type="text" class="form-control" id="deduction_type" name="deduction_type[]" value="Professional Tax"></td>
                                                    <td><input type="text" class="form-control" id="deduction_amount" name="deduction_amount[]" value="<?php echo $staff['profession_tax']; ?>"></td>
                                                    <td><button type="button" onclick="delete_deduction_row(2)" class='closebtn'><i class='fa fa-remove'></i></button></td>
                                                </tr>
                                                <tr id="deduction_row3">
                                                    <td><input type="text" class="form-control" id="deduction_type" name="deduction_type[]" value="Income Tax"></td>
                                                    <td><input type="text" class="form-control" id="deduction_amount" name="deduction_amount[]" value="<?php echo $staff['income_tax']; ?>"></td>
                                                    <td><button type="button" onclick="delete_deduction_row(3)" class='closebtn'><i class='fa fa-remove'></i></button></td>
                                                </tr>
                                                <tr id="deduction_row4">
                                                    <td><input type="text" class="form-control" id="deduction_type" name="deduction_type[]" value="Advance"></td>
                                                    <td><input type="text" class="form-control" id="deduction_amount" name="deduction_amount[]" value="<?php //echo $staff['income_tax']; ?>"></td>
                                                    <td><button type="button" onclick="delete_deduction_row(4)" class='closebtn'><i class='fa fa-remove'></i></button></td>
                                                </tr>
                                                <tr id="deduction_row5">
                                                    <td><input type="text" class="form-control" id="deduction_type" name="deduction_type[]" value="Loan"></td>
                                                    <td><input type="text" class="form-control" id="deduction_amount" name="deduction_amount[]" value="<?php //echo $staff['income_tax']; ?>"></td>
                                                    <td><button type="button" onclick="delete_deduction_row(5)" class='closebtn'><i class='fa fa-remove'></i></button></td>
                                                </tr>
