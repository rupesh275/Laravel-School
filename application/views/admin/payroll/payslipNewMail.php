    ...
    <div id="html-2-pdfwrapper">
        ...
        <div class="row" >
            <div class="col-md-12 text-right">
                <a href="#" class="print-button btn btn-primary" id="print-button" onclick="printDiv(); return false;">Print Receipt</a>
            </div>
            <!-- left column -->
            <div class="col-md-12">
                    ...
                    <table width="100%"> 
                        <tr>
                            <td>
                                ...
                                <div><img src="<?php echo base_url() ?>/uploads/print_headerfooter/staff_payslip/<?php $this->setting_model->get_payslipheader(); ?>" style="height:70px;width: 100%;" /></div>
                            </td>
                        </tr>
                    </table>
                    <table width="100%"> 
...
<script>
    function printDiv() {
        ...
        var printContent = document.getElementById('html-2-pdfwrapper').innerHTML;
