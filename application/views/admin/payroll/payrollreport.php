            ...
            <div class="col-md-12">
                <div class="box removeboxmius">
                    ...
                    <div class="box-body">
                        ...
                        <form role="form" action="<?php echo site_url('report/payrollreport') ?>" method="post" class="">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <button type="submit" name="search" value="excel" class="btn btn-primary btn-sm pr-2 checkbox-toggle pull-right"><i class="fa fa-file-excel-o"></i> <?php echo "Export Excel"; ?></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
