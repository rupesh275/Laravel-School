                        ...
                        <div class="box-header ptbnull">
                            ...
                            <div class="box-tools pull-right">
                                ...
                                if ($this->rbac->hasPrivilege('calendar_to_do_list', 'can_add')) {
                                    ...
                                    <button class="btn btn-primary btn-sm pull-right" style="margin-left: 8px;" onclick="add_task()"><i class="fa fa-plus"></i></button>
                                <?php } ?>
                                <a href="<?php echo base_url('admin/calendar/usernotes');?>" class="btn btn-primary btn-sm pull-left"> <i class="fa fa-file"></i> Notes</a>
                            </div>
                        </div>
                        <div class="">
            ...
            <div class="modal-body pb0">
                ...
                <div class="row">
                    <form role="form"  id="addtodo_form" method="post" enctype="multipart/form-data" action="">
                        ...
                        <div class="form-group col-md-12">
                            <label for="exampleInputEmail1"><?php echo "Show On Calender"; ?></label>
                            <input  type="checkbox" class="tick" autocomplete="off"  name="check" value="1"  id="checkbox">
                        </div>
                        <div class="row">
