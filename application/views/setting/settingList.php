                ...
                <div class="box box-primary">
                    <div class="box-body text-center">
                        ...
                        if ($result->admin_small_logo == "") {
                            ?>
                            <img src="<?php echo base_url() ?>uploads/school_content/logo/images.png" class="img-thumbnail" alt="Cinque Terre" width="204" height="60">
                            <?php
                        } else {
                            ?>
                            <img src="<?php echo base_url() ?>uploads/school_content/admin_small_logo/<?php echo $result->admin_small_logo; ?>" class="" alt="Cinque Terre" width="80" height="60">
                            <?php
                        }
                        ?>
                        <br/>
                        ...
                        <form role="form" id="schsetting_form" action="<?php //echo site_url('schsettings/ajax_schedit_new')      ?>" class="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="box-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label class="col-sm-4"><?php echo "Website"; ?><small class="req"> *</small></label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control"  id="website" name="sch_website" value="<?php echo $result->website; ?>">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="settinghr"></div>
                                        <h4 class="session-head"><?php echo "Next Session"; ?></h4>
                                    </div><!--./col-md-12-->
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label class="col-sm-4"><?php echo "Session Start Date"; ?><small class="req"> *</small></label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="new_session_date" name="new_session_date" value="<?php echo ""; ?>"><span class="text-danger"><?php echo form_error('phone'); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="settinghr"></div>
                                        <h4 class="session-head"><?php echo "Transfer Certificate"; ?></h4>
                                    </div><!--./col-md-12-->
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label class="col-sm-4"><?php echo "Last Certificate No"; ?><small class="req"> *</small></label>
                                            <div class="col-sm-8">
                                                <input type="number" class="form-control" id="last_certificate_no" name="last_certificate_no" value="<?php echo $result->last_certificate_no; ?>"><span class="text-danger"><?php echo form_error('last_certificate_no'); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label class="col-sm-4"><?php echo "Printing On Letterhead"; ?><small class="req"> *</small></label>
                                            <div class="col-sm-8">
                                            <label class="radio-inline">
                                                <input type="checkbox"  id="print_letter" name="print_letter" <?php
                                                    if ($result->print_letter == 1) {
                                                        echo "checked";
                                                    }
                                                    ?> value="1">
                                            </label>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="settinghr"></div>
                                        <h4 class="session-head"><?php echo "School UDISE"; ?></h4>
                                    </div><!--./col-md-12-->
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label class="col-sm-4"><?php echo "School UDISE No"; ?><small class="req"> *</small></label>
                                            <div class="col-sm-8">
                                                <input type="number" class="form-control" id="school_UDISE" name="school_UDISE" value="<?php echo $result->school_UDISE; ?>"><span class="text-danger"><?php echo form_error('school_UDISE'); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label class="col-sm-4"><?php echo "School Referal Code"; ?><small class="req"> *</small></label>
                                            <div class="col-sm-8">
                                                <input type="number" class="form-control" id="school_ref_code" name="school_ref_code" value="<?php echo $result->school_ref_code; ?>"><span class="text-danger"><?php echo form_error('school_ref_code'); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="settinghr"></div>
                                        <h4 class="session-head"><?php echo "Affilation"; ?></h4>
                                    </div><!--./col-md-12-->
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label class="col-sm-4"><?php echo "Affilation No"; ?><small class="req"> *</small></label>
                                            <div class="col-sm-8">
                                                <input type="number" class="form-control" id="affilation_no" name="affilation_no" value="<?php echo $result->affilation_no; ?>"><span class="text-danger"><?php echo form_error('affilation_no'); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="settinghr"></div>
                                        <h4 class="session-head"><?php echo "Library"; ?></h4>
                                    </div><!--./col-md-12-->
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label class="col-sm-4"><?php echo "Library Return Days"; ?><small class="req"> </small></label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="library_return_days" name="library_return_days" value="<?php echo $result->library_return_days; ?>"><span class="text-danger"><?php echo form_error('library_return_days'); ?></span>
                                            </div>
                                        </div>
                                    </div>
