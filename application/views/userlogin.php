                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12 nopadding <?php echo $bgoffsetbgno; ?> <?php echo $offset; ?>">
                                <div class="loginbg loginradius login390">
                                    ...
                                    <div class="form-bottom">
                                        <h3 class="font-white"><?php if($user_type=="parent") { echo "Parent Login"; } else { echo "Student Login"; } ?></h3>
                                        <?php
...
;
?>
                                        <form action="<?php if($user_type == "parent") { echo site_url('site/parentlogintest'); } else { echo site_url('site/userlogin'); } ?>" method="post">
                                        ...
                                        <p><a href="<?php echo site_url('site/parentregister') ?>" class="forgot"> <i class="fa fa-key"></i> <?php echo "Register now"; ?></a> </p>
                                    </div>
                                </div>
                            </div>
                            <?php
