                    ...
                    <div class="box-body" style="padding-top:0;">
                        ...
                        <div class="row no-print">
                            <div class="col-md-12 mDMb10">
                                ...
                                <button type="button" class="btn btn-sm btn-warning collectSelected" data-student_session_id="<?php echo $student['student_session_id']; ?>" id="load" data-loading-text="<i class='fa fa-spinner fa-spin '></i> <?php echo $this->lang->line('please_wait') ?>"><i class="fa fa-money"></i> <?php echo  " Refund" ; ?></button>
                            ...
                            <table class="table table-striped table-bordered table-hover example table-fixed-header">
                                ...
                                <tbody>
                                    ...
                                    foreach ($student_due_fee as $key => $val) {
                                        ...
                                        //         echo "<pre>";
                                        // print_r($fee);
                                                if ($userdata['user_type'] == "Super Admin" || $userdata['user_type'] == "Admin" || $userdata['user_type'] == "Accountant" || $userdata['user_type'] == "OfficeAdmin") {
                                    ...
                                    ?>
                                                            ...
                                                            if($old_group!=$fee_value->name) {
                                                                ...
                                                                <td><input class="checkbox grp_<?php echo $fee_value->id;  ?>" type="checkbox" name="fee_checkbox" data-fee_master_id="<?php echo $fee_value->id ?>" data-fee_session_group_id="<?php echo $fee_value->fee_session_group_id ?>" data-fee_groups_feetype_id="<?php echo $fee_value->fee_groups_feetype_id ?>"></td>
                                                                <?php } else { ?>
                                                                    <td>
    ...
    <div id="body" class="modal-dialog">
        ...
        <form id="collect_fee_group">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h4 class="modal-title"><?php echo $this->lang->line('refund') . "Refund " . $this->lang->line('fees'); ?></h4>
                </div>
                <div class="modal-body">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $(document).on('click', '.collectSelected', function() {
            ...
            $.ajax({
                type: 'POST',
                url: base_url + "studentfee/getcollectfeeRefund",
                data: {
    ...
    function collect_fee_group(print) {
        var form = $("#collect_fee_group");
        // var url = form.attr('action');
        var url = '<?php echo site_url('studentfee/refundSave'); ?>';
        var smt_btn = $(this).find("button[type=submit]");
        var total_paid = $('input#total_paid').val();
    ...
    $(document).on("click", "#pay_btns", function() {
