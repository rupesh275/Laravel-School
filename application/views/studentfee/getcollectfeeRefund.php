        ...
        <div class="col-lg-12">
            ...
            <div class="form-horizontal">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input id="date" name="collected_date" placeholder="" type="text" class="form-control date_fee" value="<?php echo date('d-m-Y');?>" readonly="readonly" autocomplete="off">
                        <span id="form_collection_collected_date_error" class="text text-danger"></span>
                    </div>
                </div>

                <!-- <div class="form-group">
                    <label for="inputEmail3" class="col-sm-3 control-label"><?php echo $this->lang->line('amount'); ?> <small class="req"> *</small> </label>
                    <div class="col-sm-9">
                        <input  name="fee_amount" id="fee_amount" placeholder="" type="text" class="form-control " value="<?php //echo $amount_to_be_pay; ?>"  autocomplete="off">
                        <span id="form_collection_fee_amount_error" class="text text-danger"></span>
                    </div>
                </div> -->
              
                <!-- <div class="form-group">
                    <label for="inputEmail3" class="col-sm-3 control-label"><?php echo $this->lang->line('discount'); ?> </label>
                    <div class="col-sm-9">
                        ...
                        <select name="discount_amt" id="discount_amt" class="form-control discount_amt">
                            <option value="" data-dis_amt="0"><?php echo $this->lang->line('select'); ?></option>
                            <?php /*
                            if (!empty($discount_not_applied)) {
                                //echo "<pre>";
                                //print_r($discount_not_applied);die();
                            foreach ($discount_not_applied as  $discountrow) {
                                if($discountrow->custom_amount > 0 ) //for custom discount amount
                                {$amt = $discountrow->custom_amount;}
                                elseif($discountrow->amount > 0 ) //for discount with amount
                                {$amt = $discountrow->amount;}
                                else
                                {$amt=0;}//for discount with out amount
                               ?>
                               <option value="<?php echo $discountrow->student_fees_discount_id; ?>" data-discid = "<?php echo $discountrow->id; ?>" data-code="<?php echo $discountrow->code;?>" data-fees_type="<?php echo $discountrow->fees_type;?>" data-total_main_fees="<?php echo $total_main_fees;?>" data-total_other_fees="<?php echo $total_other_fees;?>" data-per_cent="<?php echo $discountrow->feepercent;?>" data-dis_amt="<?php echo $amt;?>"  data-session_id="<?php echo $discountrow->session_id;?>"  ><?php echo $discountrow->code; ?></option>
                               <?php
                            }} */
                            ?>

                        </select>
                        <span id="discount_amt_error" class="text text-danger"></span>
                ...
                <!-- <div class="form-group">
                    <label for="inputEmail3" class="col-sm-3 control-label"><?php //echo $this->lang->line('fine'); ?> </label>
                    <div class="col-sm-9">
                        <input  name="total_fine_amount" id="total_fine_amount" placeholder="" type="text" class="form-control " value="<?php echo $total_fine_amount; ?>"  autocomplete="off">
                        <span id="form_collection_amount_fine_error" class="text text-danger"></span>
                    </div>
                </div> -->
                <div class="form-group">
                    <label for="inputEmail3" class="col-sm-3 control-label"><?php echo "Total Paid Fees"; ?> </label>
                    <div class="col-sm-9">
                        <input  name="total_paid_fees" id="total_paid_fees" readonly placeholder="" type="text" class="form-control " value="<?php echo $total_paid;?>"  autocomplete="off">
                        <span id="form_collection_total_paid_fees_error" class="text text-danger"></span>
                    </div>
                </div>                
                <div class="form-group">
                    <label for="inputEmail3" class="col-sm-3 control-label"><?php echo "Refund Amount"; ?> </label>
                    <div class="col-sm-9">
                        <input  name="refund_amt" id="refund_amt"  placeholder="" type="text" class="form-control " value=""  autocomplete="off">
                        <span id="form_collection_refund_amt_error" class="text text-danger"></span>
                    </div>
                </div>                
                <!-- <div class="form-group">
                ...
                <div class="form-group">
                    <label for="inputPassword3" class="col-sm-3 control-label"> <?php echo $this->lang->line('remarks') ?></label>

                    <div class="col-sm-9">
                        <textarea class="form-control" rows="3" name="remarks" id="description" placeholder=""></textarea>
                        <span id="form_collection_remarks_error" class="text text-danger"></span>
                    </div>
                </div>
...
<?php //if ($total_amount > 0) { ?>
    ...
    <div class="row fees-footer">
        <div class="col-md-12">
            ...
            <button type="button" id="pay_btns" name="print"  value="print" class="btn btn-primary pull-right payment_collect" data-actions="collect" data-loading-text="<i class='fa fa-spinner fa-spin '></i><?php echo $this->lang->line('processing') ?>"><i class="fa fa-money"></i> <?php echo $this->lang->line('pay'); ?></button>
        </div>
    </div>
<?php //} else { ?>
    <div class="row">
