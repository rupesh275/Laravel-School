...
$fine_cash = 0;$fine_bank = 0;$fine_gateway = 0;$fine_cancel = 0;
?>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box removeboxmius">
                    ...
                    <form role="form" action="<?php echo site_url('studentfee/collection_report_receipt') ?>" method="post" class="">
                        <div class="box-body row" style="display:show">
                            ...
                            <div class="form-group">
                                <div class="col-sm-12" style="display:flex;justify-content:right;">
                                    ...
                                    <div>
                                        <button type="submit" name="search" value="export" class="btn btn-primary btn-sm checkbox-toggle pull-right"> <i class="fa fa-file-excel-o"></i> <?php echo "Export"; ?></button>
                                    </div>
                                ...
                                <table class="table table-striped table-bordered table-hover " id="headerTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text text-right " style="font-weight:bold"><?php echo $fine_cash; ?></td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text text-right " style="font-weight:bold"><?php echo $fine_gateway; ?></td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text text-right " style="font-weight:bold"><?php echo $fine_bank; ?></td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text text-right " style="font-weight:bold"><?php echo $fine_cancel; ?></td>
