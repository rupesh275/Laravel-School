...
<div class="content-wrapper">
    ...
    <section class="content">
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        <table class="table table-striped mb0 font13">
                                                ...
                                                <tr>
                                                        ...
                                                        <a target="_blank" href="<?php echo base_url() . "student/view/" . $student['id']; ?>" ><td class="bozero"><?php echo $student['aadhar_name'];//$this->customlib->getFullName($student['firstname'], $student['middlename'], $student['lastname'], $sch_setting->middlename, $sch_setting->lastname); ?></td></a>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td> <?php if(!empty($class_teacher)) { echo $class_teacher['name']; } ?>
                                                        </td>
                                                    </tr>                                                    
                                                    <tr>
                                                        ...
                                                        <?php // if ($sch_setting->rte) { ?>
                                                            ...
                                                            <td><b class="text-danger"> <?php  if(!empty($class_teacher)) { echo $class_teacher['contact_no']; }  ?> </b>
                                                            </td>
                                                        <?php // } ?>
                                                        <tr>
                                                        <th><a href="<?php echo site_url('studentfee/previousfee/'.$student["student_session_id"]);?>" class="btn btn-sm btn-primary">Previous Fees</a></th>
                                                        ...
                                                        <td><a target="_blank" href="<?php echo site_url('studentfee/general_receipt/'.$student["student_session_id"]);?>" class="btn btn-sm btn-primary">General Receipt</a></td>
                                                        </tr>
                                                    </tr>
                                                </tbody>
                                            </table>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                                            ...
                                                            if($old_group!=$fee_value->name) {
                                                                ...
                                                                <td><input class="checkbox grp_<?php echo $fee_value->id;  ?>" type="checkbox" name="fee_checkbox" data-fee_master_id="<?php echo $fee_value->id ?>" data-fee_session_group_id="<?php echo $fee_value->fee_session_group_id ?>" data-fee_balance = "<?php echo $feetype_balance; ?>" data-fee_groups_feetype_id="<?php echo $fee_value->fee_groups_feetype_id ?>"></td>
                                                                <?php } else { ?>
                                                                    <td>
                                                                ...
                                                                <td></td>
                                                                <td>
                                                                <input class="checkbox grp_<?php echo $fee_value->id;  ?>" type="checkbox" name="fee_checkbox" data-fee_master_id="<?php echo $fee_value->id ?>" data-fee_session_group_id="<?php echo $fee_value->fee_session_group_id ?>" data-fee_balance = "<?php echo $feetype_balance; ?>" data-fee_groups_feetype_id="<?php echo $fee_value->fee_groups_feetype_id ?>">
                                                                </td>
                                                                <?php } ?>
                                                                <td align="left"><?php
                                                                                    echo  $fee_value->type;
                                                                ...
                                                                if (!empty($fee_value->amount_detail)) {
                                                                    ...
                                                                    foreach ($fee_deposits as $fee_deposits_key => $fee_deposits_value) {
                                                                        ...
                                                                        if($fee_deposits_value->amount_discount > 0 || $fee_deposits_value->amount_fine > 0 || $fee_deposits_value->amount > 0) {
                                                                ?>
                                                                        <tr class="white-td">
                                                                            <td align="left"></td>
                                                                            <td align="left"></td>
                                                                            ...
                                                                            <td class="text text-right">
                                                                                <div class="btn-group ">
                                                                                    <div class="pull-right">
                                                                                        ...
                                                                                        <?php }  ?>
                                                                                        <!--
                                                                                        <button class="btn btn-xs btn-default printDoc" data-student_session_id="<?php echo $student_session_id[$i]; ?>" data-percentage="<?php //echo $fee_value->
                                                                                                                                                                                                                        ?>" data-discount_amt="<?php echo $fee_deposits_value->amount_discount; ?>" data-payment_id="<?php echo  $fee_deposits_value->inv_no; ?>" data-full_amount="<?php echo $total_amount; ?>" data-fee_master_id="<?php echo $fee_value->id ?>" data-fee_groups_feetype_id="<?php echo $fee_value->fee_groups_feetype_id ?>" data-paidamt="<?php echo $fee_paid; ?>" data-main_invoice="<?php echo $fee_value->student_fees_deposite_id ?>" data-sub_invoice="<?php echo $fee_deposits_value->inv_no ?>" title="<?php echo $this->lang->line('print'); ?>"><i class="fa fa-print"></i> </button>
                                                                                        -->    
                                                                                    </div>
                                                                                </div>
                                                                            </td>
                                                                ...
                                                                if($old_group!=$fee_value->name) {
                                                                    ...
                                                                    ?>
                                                                            <tr class="white-td">
                                                                                ...
                                                                                <td class="text text-left">
                                                                                    <?php ;
                                                                                        if($userdata['id']==1 && $fee_deposits_value->inv_no == 3973)
                                                                                        {
                                                                                            $fnamt=get_fine1($fee_deposits_value->inv_no,$main_fees);
                                                                                        }
                                                                                        else
                                                                                        {
                                                                                            $fnamt=get_fine($fee_deposits_value->inv_no,$main_fees);
                                                                                        }
                                                                                        $main_fees = $fnamt['main_f'];
                                                                                        $fn_amt = $fnamt['fine'];
                                                                                        if($fn_amt > 0) { $total_rece_fin += $fn_amt; }
                                                                                     ?>
                                                                                    <a href="#" data-toggle="popover" class="detail_popover"> <?php echo $fee_deposits_value->inv_no."--"; ?></a>
                                                                                    <div class="fee_detail_popover" style="display: none">
                                                                                        <?php
                                                                                ...
                                                                                <td class="text text-right"><?php echo (number_format($fee_deposits_value->amount_discount, 2, '.', '')); ?></td>
                                                                                <td class="text text-right"><?php echo  (number_format($fn_amt, 2, '.', '')); ?></td>
                                                                                <td class="text text-right"><?php echo (number_format($fee_deposits_value->amount, 2, '.', '')); ?></td>
                                                                                <td></td>
                                                                                <td class="text text-right">
                                                                                    <div class="btn-group ">
                                                                                        <div class="pull-right">
                                                                                            <?php if ($this->rbac->hasPrivilege('collect_fees', 'can_delete')) { ?>
                                                                                                ...
                                                                                                <!--
                                                                                                <button class="btn btn-xs btn-default" id="editbtn" data-id="<?php echo  $fee_value->student_fees_deposite_id;   ?>" data-sub_invoice = "<?php echo $fee_deposits_value->inv_no; ?>" data-mode="<?php echo $fee_deposits_value->payment_mode; ?>" data-note="<?php echo $value->note; ?>" data-toggle="modal" data-target="#edit_receipt"  title="<?php echo "Edit"; ?>">
                                                                                                    <i class="fa fa-edit"></i>
                                                                                                </button>                                                                                                 
                                                                                                -->
                                                                                            <?php } ?>
                                                                                            ...
                                                                                            <!--                                                                                                                    
                                                                                            <button class="btn btn-xs btn-default updateDiscount" data-id = "<?php echo $fee_value->id; ?>" data-fee_type_id = "<?php echo $fee_value->fee_groups_feetype_id; ?>" data-invoice_id="<?php echo $fee_deposits_value->inv_no; ?>"  title="<?php echo "Assign Disc."; ?>"><i class="fa fa-tag"></i> </button> 
                                                                                            -->
                                                                                    </div>
                                                                                </td>
                                                                            </tr>
                                        ...
                                        $i++;
                                            ...
                                            <tr class="box box-solid total-bg">
                                                ...
                                                <td class="text text-right"><?php
                                                                            ...
                                                                            ?></td>
                                                <td class="text text-right"><?php
                                                                            echo ($currency_symbol . number_format($total_rece_fin, 2, '.', ''));
                                                                            ?></td>
                                                <td class="text text-right"><?php
        ...
        <input type="hidden" name="oldfees" id="oldfees" value = "<?php echo $is_prev_year; ?>">
        <input type ="hidden" name ="prev_paid" id = "prev_paid" value = "<?php echo $prev_paid; ?>" >
    </section>
    <section class="content">
        <div class="row">
            <!-- left column -->
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <table class="table table-striped mb0 font13">
                        <thead>
                            <tr>
                                <th class="bozero">Reciept No</th>
                                <th class="bozero">Date</th>
                                <th class="bozero">Fees Type </th>
                                <th class="bozero">Fees Amount</th>
                                <th class="bozero">Mode of Payment</th>
                                <th class="bozero">Remarks</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php 
                            ...
                            foreach($receipt_type as $Rec_Row){ ?>
                            <tr>
                                <td><?php echo $Rec_Row['receipt_id']; ?></td>
                                <td><?php echo date('d-m-Y',strtotime($Rec_Row['date'])); ?></td>
                                <td><?php echo $Rec_Row['type']; ?></td>
                                <td><?php echo $Rec_Row['amt']; ?></td>
                                <td><?php echo $Rec_Row['payment_mode']; ?></td>
                                <td><?php echo $Rec_Row['remarks']; ?></td>
                            </tr>
                            <?php } }?>
                        </tbody>
                    </table>
...
<div class="discount_update modal fade" id="discount_update" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body">
                <input type="hidden" name="main_invoice" id="main_invoice" value="">
                <input type="hidden" name="sub_invoice" id="sub_invoice" value="">
                <div class="form-group">
                    <label for="inputPassword3" class="col-sm-3 control-label"><?php echo "Select Discount"; ?></label>
                    <div class="col-sm-8">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo "Submit"; ?>
                <a class="btn btn-danger btn-ok"><?php echo "Assign Disc"; ?></a>
            </div>
        </div>
    </div>
</div>
...
<div class="editmodal modal fade" id="edit_receipt" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo $this->lang->line('cancel'); ?></button>
                <a class="btn btn-danger btn-edit_receipt_ok"><?php echo "Update"; ?></a>
            </div>
        </div>
    </div>
</div>
...
<div id="listCollectionModal" class="modal fade">
    <div id="body" class="modal-dialog">
        <div id="loader" class="center loader" style="display:none;"></div>
...
<?php
function get_fine($rec_id,$main_fees)
{
    $rw=0;
    // if($userdata['id']==1)
    // {
    //     echo "<pre>";print_r($main_fees);die();
    // }
    foreach($main_fees as $fees_m)
    {
        if($fees_m['id']==$rec_id && $fees_m['fine'] > 0 && $fees_m['cancel_reason'] != -1)
        {
            $fees_m['cancel_reason'] = -1;
            $main_fees[$rw]['cancel_reason'] = -1;
            return array('main_f'=>$main_fees,'fine'=>$fees_m['fine']);
        }
        ++$rw;
    }
    return array('main_f'=>$main_fees,'fine'=>0);
}
function get_fine1($rec_id,$main_fees)
{
    $rw=0;
    foreach($main_fees as $fees_m)
    {
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $(document).on('click', '.printSelected', function() {
            var array_to_print = [];
            var oldfees = $('input#oldfees').val();
            if(oldfees==1 )
            {
                alert("Please paid previous fees");
                return true;
            }
        ...
        $(document).on('click', '.collectSelected', function() {
            var $this = $(this);
            var payment_mode = $('input[name="enable_auto_disc"]:checked').val();
            var fine_mode = $('input[name="enable_fine"]:checked').val();
            var student_session_id = $(this).data('student_session_id');
            var total_main_fees = $('input#total_main_fees').val();
            var total_other_fees = $('input#total_other_fees').val();
            var total_balance_fees = $('input#total_balance').val();
            var prev_paid = $('input#prev_paid').val();
            var array_to_collect_fees = [];
            var fee_balance_total = 0;
            var oldfees = $('input#oldfees').val();
            var enable_auto_disc = 0;
            if(payment_mode)
            {enable_auto_disc=1;}
            else
            {enable_auto_disc=0;}
            if(fine_mode)
            {fine_selection=1;}else{fine_selection=0;}
            ...
            $.each($("input[name='fee_checkbox']:checked"), function() {
                ...
                var fee_master_id = $(this).data('fee_master_id');
                var fee_groups_feetype_id = $(this).data('fee_groups_feetype_id');
                var fee_balance = $(this).data('fee_balance');

                fee_balance_total = fee_balance_total + fee_balance;
                item = {};
                item["fee_session_group_id"] = fee_session_group_id;
                item["fee_master_id"] = fee_master_id;
                item["fee_groups_feetype_id"] = fee_groups_feetype_id;
            ...
            $.ajax({
                ...
                data: {
                    ...
                    selected_balance:fee_balance_total,
                    enable_auto_disc:enable_auto_disc,
                    prev_paid:prev_paid,
    ...
    function calc_total()
    {
                ...
                var tot_disc = 0;
                tot_fine =  $('#net_fine').val();
                balance_amount = $('#paid_amount').val();
                if(tot_fine>0)
                {
                    balance_amount = parseFloat(balance_amount) - parseFloat(tot_fine);
                }                
                $('.item_count').each(function(index,element) {
                    itm_cnt =  $(element).data('no');
                    ...
                    //console.log(org_fee_amount);
                    
                    tot_fine_amount = parseFloat(tot_fine_amount) + parseFloat(fine_amount);
                    tot_disc = tot_disc +  parseFloat($('#amount_discount_' + itm_cnt).val());
                    //console.log( itm_cnt + '-' +  tot_fine_amount);
                    if(balance_amount>0)
                    {
      
                        console.log( balance_amount + ' - ' + org_fee_amount + '=' + (parseFloat(org_fee_amount) + parseFloat(disc) - parseFloat(fine_amount)).toFixed(2));
                        ...
                        else
                        {
                            ...
                            $('#fee_amount_' + itm_cnt).val(parseFloat(balance_amount) + parseFloat(disc));
                            $('#dis_fee_amount_' + itm_cnt).html("Rs." + (parseFloat(balance_amount) + parseFloat(disc)));
                            balance_amount=0;
                        }
                    }
                    else
                ...
                if(tot_disc>0)
                {
                    $('#discount_text').text("Rs." + tot_disc.toFixed(2));
                }                   
                balance_amount= parseFloat(calc_paid_amount) + parseFloat(tot_fine_amount) + parseFloat(tot_fine) ;
    ...
    function clear_discount_onetime()
    {
            var itm_cnt=0;
                $('.item_count').each(function(index,element) {

                    itm_cnt =  $(element).data('no');
                    discid = $('#disc_code_' + itm_cnt).val();
                    if(discid==4)
                    {
                        $('#disc_code_' + itm_cnt).val('');
                        $('#amount_discount_' + itm_cnt).val(0);                
                    }
                });     
    }    
        ...
        $(function() {
        $(document).on('change', ".date_fee", function() {
            apply_one_time_discount();
            })
        });
        $(function() {
        $(document).on('blur', "#net_fine", function() {
            calc_total();
            amt = parseFloat($('#valid_amount').val());
            $("#paid_amount").val(amt);
            $('.total_amt_').val(amt);
            if(parseFloat($('#valid_amount').val())!= parseFloat($('#paid_amount').val()))
                {
        ...
        $(document).on('change', "#discount_amt", function() {
            var otenabled = parseFloat($("#ot_disc").data('otenabled'));
            var amount = parseFloat($('option:selected', this).data('dis_amt'));
            var discid = parseFloat($('option:selected', this).data('discid'));
            ...
            var am=0;
            var balance_amount = 0;
            if(code == 'EFD' && otenabled == 0 )
            {return 0;}
            else if(code == 'SIBL-DIS' && otenabled == 0)
            {return 0;}
            disc_amt=0;
            disc_collected = 0;
            clear_discount();
            ...
            $('.item_count').each(function(index,element) {
                ...
                org_fee_amount = $("#org_fee_amount_" + itm_cnt).val();
                dsid = $('#disc_code_' + itm_cnt).val();
                
                if(disc_amt>0 && (dsid == '' || dsid == 0) )
                {
                    if (fees_type == "m" && fee_code.substring(0,3) == 'TUT') {
                        if ( parseFloat(disc_amt) > 0 && parseFloat(disc_amt) <= parseFloat(fee_amount) ) {
                            $('#amount_discount_' + itm_cnt).val(disc_amt.toFixed(2));
                            totdisc = totdisc + parseFloat(disc_amt);
                            disc_amt = 0
                            
                            $('#disc_code_' + itm_cnt).val(discid);   
                        }else if( parseFloat(disc_amt) > 0 && parseFloat(disc_amt) > parseFloat(fee_amount) ) {
                            $('#amount_discount_' + itm_cnt).val(fee_amount);
                            $('#disc_code_' + itm_cnt).val(discid);
                            disc_amt = disc_amt - parseFloat(fee_amount);
                            totdisc = totdisc + parseFloat(fee_amount);
                        }                    
                    }
                    else if (fees_type != "m" ) 
                    {
    ...
    function apply_one_time_discount()
    {
        
        if(!$('input[name="enable_auto_disc"]:checked').val())
        {return false;}
        
        clear_discount_onetime();
        var amount = parseFloat($("#ot_disc").data('dis_amt'));
        var otenabled = parseFloat($("#ot_disc").data('otenabled'));
        var fee_amount = parseFloat($('.total_amt_').val());
        var percent = $("#ot_disc").data('per_cent');
        var total_main_fees = $("#ot_disc").data('total_main_fees');
        var last_date = new Date($("#ot_disc").data('lastdate'));
        var s = $('input[name=collected_date]').val().split('-');
        var paid_date = new Date(`${s[1]}/${s[0]}/${s[2]}`);
        if(paid_date<=last_date && otenabled == 1)
        {
            
            var total_other_fees = $("#ot_disc").data('total_other_fees');
            var fees_type = $("#ot_disc").data('fees_type');
            var code = $("#ot_disc").data('code');
            var discid = $("#ot_disc").data('discid');
            var am=0;
            var balance_amount = 0;
            var applied = 0;
            disc_amt=0;
            ...
            $('.item_count').each(function(index,element) {
                ...
                balance_amount = parseFloat(balance_amount) + parseFloat(fee_amount);
                org_fee_amount = $("#org_fee_amount_" + itm_cnt).val();
                applied_disc_amt = parseFloat($('#amount_discount_' + itm_cnt).val());
                
                if(applied==0)
                {
                    if(applied_disc_amt==0  && disc_amt > 0)
                    {
                        if(fee_code.substring(0, 3)=='TUT') 
                        {
                            if ( parseFloat(disc_amt) > 0 && parseFloat(disc_amt) <= parseFloat(fee_amount) ) {
                                $('#amount_discount_' + itm_cnt).val(disc_amt.toFixed(2));
                                disc_amt = 0;
