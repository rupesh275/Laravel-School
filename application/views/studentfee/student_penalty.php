            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix"><?php echo $this->lang->line('student') . " Penalty"; ?> </h3>
                        <div class="box-tools pull-right">
                            <?php if ($this->rbac->hasPrivilege('student_penalty', 'can_add')) { ?>
                                <small class="pull-right"><a href="<?php echo site_url('studentfee/add_penalty') ?>" role="button" class="btn btn-primary btn-sm checkbox-toggle pull-right"><?php echo $this->lang->line('add'); ?></a></small>
                            <?php } ?>
                        </div>
                    </div><!-- /.box-header -->
                    <div class="box-body">
                                ...
                                <div class="tab-pane active table-responsive no-padding">
                                    ...
                                    <table class="table table-striped table-bordered table-hover example">
                                        <thead>
                                            ...
                                            <th><?php echo $this->lang->line('fee') . " " . $this->lang->line('date'); ?></th>
                                        ...
                                        <tbody>
                                            <?php
                                            $i = 0;
                                            foreach ($student_penaltylist as $key => $value) {
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><a href="<?php echo base_url(); ?>student/view/<?php echo $value['student_id']; ?>"><?php echo $value['firstname'] . " " . $value['lastname'];
                                                        ...
                                                        <!-- <td><?php //echo $value["date"] 
                                                                    ?></td> -->
                                                    <td><?php echo date($this->customlib->getSchoolDateFormat(), strtotime($value["fee_date"])) ?></td>

                                                    <td><?php echo $value["subject"]; ?></td>
                                                    <td><?php echo $value["fine"]; ?></td>
                                                    <!-- <td><?php //echo date($this->customlib->getSchoolDateFormat(), strtotime($value["date"])); 
                                                                ?></td> -->
                                                    <td>
                                                        <div class="btn-group">
                                                            <div class="pull-right">
                                                            <button class="btn btn-xs btn-default printInv" data-student_session_id="<?php echo $value['student_session_id'] ?>" title="<?php echo $this->lang->line('print'); ?>"><i class="fa fa-print"></i> </button>

                                                                <?php
                                                                if ($this->rbac->hasPrivilege('fees_group', 'can_edit')) {
                                                                ?>
                                                                    <a data-placement="left" href="<?php echo base_url(); ?>studentfee/edit_penalty/<?php echo $value['student_session_id'] ?>" class="btn btn-default btn-xs" data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
                                                                ...
                                                                ?>
                                                                    <a data-placement="left" href="<?php echo base_url(); ?>studentfee/delete_penalty/<?php echo $value['student_session_id'] ?>" class="btn btn-default btn-xs" data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
...
<script type="text/javascript">
    $(document).on('click', '.printInv', function() {
        ...
        $.ajax({
            url: '<?php echo site_url("studentfee/print_penaltyfee") ?>',
            type: 'post',
            data: {
