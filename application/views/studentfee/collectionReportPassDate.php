        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box removeboxmius">
                    ...
                    <form role="form" action="<?php echo site_url('studentfee/collectionReportPassDate') ?>" method="post" class="">
                                ...
                                <table class="table table-striped table-bordered table-hover " id="headerTable">
                                    <thead class="header">
                                        <tr>
                                            ...
                                            <!-- <th><?php //echo $this->lang->line('admission_no'); 
                                                        ?></th> -->
                                            <th><?php echo "Reconsile To"; ?></th>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr style="<?php echo $color; ?>">
                                                ...
                                                <!-- <td class="text-left-md"><?php //echo $value->admission_no; 
                                                                                ?></td> -->
                                                <td class="text-left-md"><?php echo $value->bank_head; ?></td>
                                                <td class="text-left-md"><?php echo date('d-m-Y', strtotime($value->pass_date)); ?></td>
