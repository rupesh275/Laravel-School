                                            ...
                                            <table class="table table-striped mb0 font13">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="bozero"><?php echo $student['aadhar_name']; //echo $this->customlib->getFullName($student['firstname'], $student['middlename'], $student['lastname'], $sch_setting->middlename, $sch_setting->lastname); ?></td>
...
<script type="text/javascript">
    ...
    $(function() {
        $(document).on('change', "#discount_amt", function() {
            ...
            var balance_amount = parseFloat(fee_amount) - parseFloat(amount);
            // console.log(balance_amount);
            // console.log(fee_amount);

            // $('#total_amt').text(balance_amount.toFixed(2));
            if (amount == 0) {
                // console.log(fee_amount);
                $('#total_amt_').text("Rs." + fee_amount.toFixed(2));
                $('#fee_amount').val(fee_amount + ".00");
                $('#discount_text').text("Rs.0.00");
                $('#valid_amount').val(fee_amount);
            } else {
                $('#total_amt_').text("Rs." + balance_amount.toFixed(2));
                $('#valid_amount').val(balance_amount);
                $('#fee_amount_').val(balance_amount.toFixed(2));
                $('#amount_discount_1').val(amount.toFixed(2));
                $('#discount_text').text("Rs." + amount.toFixed(2));
                //    console.log(amount);
            }
    ...
    function collect_fee_group(print) {
        ...
        $.ajax({
            ...
            url: url,
            dataType: 'JSON',
            data: form.serialize() + "&print=" + print + "&total_paid=" + total_paid + "&total_balance=" + total_balance, // serializes the form's elements.
            beforeSend: function() {
                smt_btn.button('loading');
            },
            success: function(response) {
