        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form method="post" action="<?php echo site_url('studentfee/addfeestudentgroup') ?>" id="assign_form">
                        <?php
                        // Display php ini errors
                                            ...
                                            <div class="col-md-12">
                                                <div class="table-responsive">
                                                    <table class="table table-striped">
                                                        <thead>
                                                            <tr>
                                                                <th><input type="checkbox" name="select_all_group" id="select_all_group"></th>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            if (!empty($fees_array)) {
                                                                foreach ($fees_array as $fee) {
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <input class="checkbox_group" type="checkbox" name="fees_group_id[]" value="<?php echo $fee['fees_group_id']; ?>" />
                                                                        </td>
                                                                        <td><?php echo $feegroup->group_name; ?></td>
                                                                    </tr>
                                                                    <?php
                                                                }
                                                            }
                                                            ...
                                                            ?>
                                                                ...
                                                                ?>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <?php
                                                                            $rows = $this->db->from('student_fees_master')->where('student_session_id',$student['student_session_id'])->get()->num_rows();
                                                                            if ($rows > 0) {
                                                                                $sel = "checked='checked'";
                                                                            } else {
                                                                                $sel = "";
...
<script type="text/javascript">
    ...
    $("#select_all_group").change(function() { //"select all" change 
        $(".checkbox_group").prop('checked', $(this).prop("checked")); //change all ".checkbox" checked status
    });
    ...
    $("#assign_form").submit(function(e) {
        e.preventDefault();
        if ($("input[name='fees_group_id[]']:checked").length === 0) {
