                        ...
                        <div class="box box-primary">
                            ...
                            <div class="box-body">
                                <div class="mailbox-messages ">
                                    <div class="download_label"><?php echo " "; ?></div>
                                    <!-- <div class=" box-tools impbtntitle"> -->
                                    <form id="form" method="post">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('fee') . " " . $this->lang->line('date'); ?></label>
                                                    <input id="fee_date" name="fee_date" placeholder="" type="text" class="form-control date" value="<?php echo set_value('fee_date', date('d-m-Y', strtotime($penaltylist['fee_date']))); ?>" />
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select name="fee_type" id="fee_type" class="form-control">
                                                        ...
                                                        <option value="1" <?php
                                                                            if ($penaltylist['fee_type'] == "1") {
                                                                                echo "selected";
                                                                            } ?>><?php echo $this->lang->line('lost'); ?><?php echo " & Damage"; ?></option>
                                                        <option value="2" <?php
                                                                            if ($penaltylist['fee_type'] == "2") {
                                                                                echo "selected";
                                                                            } ?>><?php echo "Behaviour"; ?></option>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input id="subject" name="subject" placeholder="" type="text" class="form-control " value="<?php echo set_value('subject', $penaltylist['subject']); ?>" />
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                ...
                                                <textarea id="description" name="description" placeholder="" class="form-control" rows="2"><?php echo set_value('description', $penaltylist['description']); ?></textarea>
                                                <span class="text-danger"><?php echo form_error('description'); ?></span>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('fine'); ?></label>
                                                    <input id="fine" name="fine" placeholder="" type="text" class="form-control " value="<?php echo set_value('fine', $penaltylist['fine']); ?>" />
