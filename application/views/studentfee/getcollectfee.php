    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <input type="hidden" id="previous_paid" name="previous_paid" value = "<?php echo $prev_paid; ?>" >
                    </div>
                </div>
                <?php
                $row_counter = 1;
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <label class="radio-inline">
                            <input type="radio" name="payment_mode_fee" value="Cash"> <?php echo $this->lang->line('cash'); ?></label>
                        <label class="radio-inline">
                            <input type="radio" name="payment_mode_fee" value="Cheque" checked="checked"> <?php echo $this->lang->line('cheque'); ?></label>
                        <label class="radio-inline">
                        ...
                        <label class="radio-inline">
                            <input type="radio" name="payment_mode_fee" value="gateway"><?php echo "Gateway"; ?>
                        </label>                          
                        <span class="text-danger" id="payment_mode_error"></span>
                        <input type="hidden" id="radio_temp" value = "">
                    </div>
                    <span id="form_collection_payment_mode_fee_error" class="text text-danger"></span>
                </div>
                <div class="form-group" id="chq_details" style="align:right;margin-left:120px;">
                    <div class="col-sm-4">
            ...
            <ul class="fees-list fees-list-in-box">
                ...
                if ($student_fine_amt > 0 )
                {$inst_fine = $student_fine_amt;}
                else
                {$inst_fine=0;}    
                $total_amount += $inst_fine;   
                ...
                <li class="item">
                    <div class="product-info">
                    <a href="#" onclick="return false;" class="product-title text "><?php echo "Fine"; ?>
                                        <span class="pull-right " id="fine_text">
                                            
                                            <input type="text" name="net_fine" id="net_fine" style="text-align:right;" value="<?php echo $inst_fine; ?>">
                                        </span>
                                    </a>                        
                    </div>
                </li>                
